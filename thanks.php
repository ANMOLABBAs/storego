...
<div class="customer account">
    <h1 class="heading text-left"><span>Your Order</span></h1>
	
	<div style="width:100%;overflow:hidden;text-align:center;">
	
	<div style="width:100%;overflow:hidden;text-align:center;font-size:35px;">Thanks For Shopping With Us!</div>
	<div style="width:100%;overflow:hidden;text-align:center;font-size:35px;">Order # <?php echo $_REQUEST['order_id']; ?></div>
	<br/>
	<div style="width:100%;overflow:hidden;border:1px solid #333333;">
		<div style="width:7%;float:left;font-size:23px;padding:8px;border:1px solid #333333;">Sr#</div>
		<div style="width:43%;float:left;font-size:23px;padding:8px;border:1px solid #333333;">Product Name</div>
		<div style="width:25%;float:left;font-size:23px;padding:8px;border:1px solid #333333;">Product Quantity</div>
		<div style="width:25%;float:left;font-size:23px;padding:8px;border:1px solid #333333;">Product Price</div>
	</div>
...
<?php 
				...
				$get_data="SELECT * FROM `order_details` where order_id='".$id1."' and user_id='".$_SESSION['login_username_id']."'";
				$result_data=mysqli_query($conn,$get_data);
				$rowcount_data=mysqli_num_rows($result_data);
				$sr=0;
                 ...
                 $toatal_quantity='0';
                 $quantity='0';
				$thanks_details="SELECT *FROM `cart_order` where  order_id='".$id1."' and  user_id='".$_SESSION['login_username_id']."'";
				$result=mysqli_query($conn,$thanks_details);
 				$rowcount=mysqli_num_rows($result);
				$quantitye=0;
				...
				$product_id=$row['product_id'];
 				...
 				$toatal_quantity+=$quantity;
                  $all_total='0';
 				 $total_sale_price='0';
				 $total_products_price='0';
				$get_product="SELECT * FROM `add_product` where product_id='".$product_id."'";
				$result_get_product=mysqli_query($conn,$get_product);
 				$rowcount_get_product=mysqli_num_rows($result_get_product);				 
				while ($row_get_product=mysqli_fetch_array($result_get_product)) {
 				$sr=$sr+1;
 				$product_title=$row_get_product['title'];
				$sale_price=$row_get_product['sale_price'];
			    $total_sale_price+=$sale_price;
	
				$product_price=$total_sale_price*$quantity;
...
?>	
	...
	<div style="width:100%;overflow:hidden;border:1px solid #333333;margin-top:-1px;">
		<div style="width:7%;float:left;font-size:23px;padding:8px;border:1px solid #333333;"><?php echo $sr; ?></div>
		<div style="width:43%;float:left;font-size:23px;padding:8px;border:1px solid #333333;"><?php echo $product_title; ?></div>
		<div style="width:25%;float:left;font-size:23px;padding:8px;border:1px solid #333333;"><?php echo $quantity; ?></div>
		<div style="width:25%;float:left;font-size:23px;padding:8px;border:1px solid #333333;">$ <?php echo $product_price; ?></div>
	</div>	
	
<?php } ?>	
	<br/>
	<div style="width:100%;overflow:hidden;text-align:center;">
		<div style="width:50%;overflow:hidden;float:left;font-size:26px; text-align:center; border:2px solid #333333;">Quantity</div>
		<div style="width:50%;overflow:hidden;float:left;font-size:26px; text-align:center; border:2px solid #333333;margin-left:-2px;"><?php echo $toatal_quantity; ?></div>	
	</div>
	<div style="width:100%;overflow:hidden;text-align:center; margin-top:-2px;">
		<div style="width:50%;overflow:hidden;float:left;font-size:26px; text-align:center; border:2px solid #333333;">Total Price</div>
		<div style="width:50%;overflow:hidden;float:left;font-size:26px; text-align:center; border:2px solid #333333;margin-left:-2px;"> $ <?php echo $total_price; ?></div>	
