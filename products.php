...
$get_users="select * from add_cart where product_id='".$id2."'";
...
$insert_cart="UPDATE `add_cart` SET `quantity` = '".$qty."' WHERE `product_id` = ".$id2."";
$conn->query($insert_cart);
header("location:products.php?cart_added_product=".$id2."");

}else{


$insert_cart="INSERT INTO `add_cart` (`cart_id` ,`product_id` ,`user_id`,`quantity`)VALUES (NULL , '".$id2."', '".$_SESSION['login_username_id']."','1');";
$conn->query($insert_cart);
header("location:products.php?cart_added_product=".$id2."");
}
...
if (isset($_REQUEST['add_to_wishlist'])) {
	...
	$wishlist_added=$_GET['add_to_wishlist'];
	
	
	$select_wishlist="SELECT * FROM `wishlist` where product_id='".$wishlist_added."'";
	$result_wishlist=mysqli_query($conn,$select_wishlist);
	$rowcount_wishlist=mysqli_num_rows($result_wishlist);
	
	if ($rowcount_wishlist>0) {

header("location:wishlist.php");

}else {

echo $insert_wishlist="INSERT INTO `wishlist`(`wishlist_id`, `user_id`, `product_id`) VALUES (NULL, '".$_SESSION['login_username_id']."', '".$wishlist_added."')";
$conn->query($insert_wishlist);
...
<html class="no-js wbboxlt" lang="en" >
  <head>
    ...
    <link rel="canonical" href="https://storego-demo.myshopify.com/collections/camera">
 ...
 &ndash; storego-demo</title>
      ...
      <meta name="description" content="Maecenas id nulla tempor, scelerisque velit at, porta tortor. Suspendisse ornare, mi vel egestas vehicula, neque ante iaculis lacus, ac maximus nisl ligula non turpis. Ut mattis, dolor et feugiat sodales, eros nibh viverra dui, eu luctus ex velit nec ipsum. Nullam nec mattis mauris. Cras non risus felis. Aenean et dign">
    

    

<meta property="og:site_name" content="storego-demo">
<meta property="og:url" content="https://storego-demo.myshopify.com/collections/camera">
<meta property="og:title" content="Camera">
<meta property="og:type" content="product.group">
<meta property="og:description" content="Maecenas id nulla tempor, scelerisque velit at, porta tortor. Suspendisse ornare, mi vel egestas vehicula, neque ante iaculis lacus, ac maximus nisl ligula non turpis. Ut mattis, dolor et feugiat sodales, eros nibh viverra dui, eu luctus ex velit nec ipsum. Nullam nec mattis mauris. Cras non risus felis. Aenean et dign"><meta property="og:image" content="http:https://cdn.shopify.com/s/files/1/0257/0492/3199/collections/7.png?v=1575009502">
  <meta property="og:image:secure_url" content="https:https://cdn.shopify.com/s/files/1/0257/0492/3199/collections/7.png?v=1575009502">
...
<meta name="twitter:description" content="Maecenas id nulla tempor, scelerisque velit at, porta tortor. Suspendisse ornare, mi vel egestas vehicula, neque ante iaculis lacus, ac maximus nisl ligula non turpis. Ut mattis, dolor et feugiat sodales, eros nibh viverra dui, eu luctus ex velit nec ipsum. Nullam nec mattis mauris. Cras non risus felis. Aenean et dign">
...
<link rel="alternate" hreflang="x-default" href="https://storego-demo.myshopify.com/collections/camera">
<link rel="alternate" hreflang="en-IN" href="https://storego-demo.myshopify.com/collections/camera">
<link rel="alternate" hreflang="ar-IN" href="https://storego-demo.myshopify.com/ar/collections/camera">
<link rel="alternate" hreflang="en-US" href="https://storego-demo.myshopify.com/en-us/collections/camera">
<link rel="alternate" hreflang="ar-US" href="https://storego-demo.myshopify.com/ar-us/collections/camera">
<link rel="alternate" type="application/json+oembed" href="https://storego-demo.myshopify.com/collections/camera.oembed">
<script>
  (function() {
...
<script id="__st">var __st={"a":25704923199,"offset":-14400,"reqid":"f6c95e14-e9c0-4907-a89e-9927ce2d2941","pageurl":"storego-demo.myshopify.com\/collections\/camera","u":"c400601782dd","p":"collection","rtyp":"collection","rid":156191916095};</script>
...
<script id="web-pixels-manager-setup">(function e(e,n,a,t,o,r,i){var s=i||[],l=null!==e;l&&(window.Shopify=window.Shopify||{},window.Shopify.analytics=window.Shopify.analytics||{},window.Shopify.analytics.replayQueue=[],window.Shopify.analytics.publish=function(e,n,a){window.Shopify.analytics.replayQueue.push([e,n,a])});var d=function(){var e="legacy",n="unknown",a=null,t=navigator.userAgent.match(/(Firefox|Chrome)\/(\d+)/i),o=navigator.userAgent.match(/(Edg)\/(\d+)/i),r=navigator.userAgent.match(/(Version)\/(\d+)(.+)(Safari)\/(\d+)/i);r?(n="safari",a=parseInt(r[2],10)):o?(n="edge",a=parseInt(o[2],10)):t&&(n=t[1].toLocaleLowerCase(),a=parseInt(t[2],10));var i={chrome:60,firefox:55,safari:11,edge:80}[n];return void 0!==i&&null!==a&&i<=a&&(e="modern"),e}().substring(0,1),c=t.substring(0,1);if(l)try{self.performance.mark("wpm:start")}catch(e){}var p,u,f,w,h,y,m,g,v=[a,s.indexOf("web_pixels_manager_runtime_asset_prefix")>-1?"/wpm":null,"/",c,r,d,".js"].join("");p={src:v,async:!0,onload:function(){if(e){var a=window.webPixelsManager.init(e);n(a),window.Shopify.analytics.replayQueue.forEach((function(e){a.publishCustomEvent(e[0],e[1],e[2])})),window.Shopify.analytics.replayQueue=[],window.Shopify.analytics.publish=a.publishCustomEvent}},onerror:function(){var n=(e.storefrontBaseUrl?e.storefrontBaseUrl.replace(/\/$/,""):self.location.origin)+"/.well-known/shopify/monorail/unstable/produce_batch",a=JSON.stringify({metadata:{event_sent_at_ms:(new Date).getTime()},events:[{schema_id:"web_pixels_manager_load/2.0",payload:{version:o||"latest",page_url:self.location.href,status:"failed",error_msg:v+" has failed to load"},metadata:{event_created_at_ms:(new Date).getTime()}}]});try{if(self.navigator.sendBeacon.bind(self.navigator)(n,a))return!0}catch(e){}const t=new XMLHttpRequest;try{return t.open("POST",n,!0),t.setRequestHeader("Content-Type","text/plain"),t.send(a),!0}catch(e){console&&console.warn&&console.warn("[Web Pixels Manager] Got an unhandled error while logging a load error.")}return!1}},u=document.createElement("script"),f=p.src,w=p.async||!0,h=p.onload,y=p.onerror,m=document.head,g=document.body,u.async=w,u.src=f,h&&u.addEventListener("load",h),y&&u.addEventListener("error",y),m?m.appendChild(u):g?g.appendChild(u):console.error("Did not find a head or body element to append the script")})({shopId: 25704923199,storefrontBaseUrl: "https://storego-demo.myshopify.com",cdnBaseUrl: "https:https://cdn.shopify.com",surface: "storefront-renderer",enabledBetaFlags: ["web_pixels_use_shop_domain_monorail_endpoint","web_pixels_shopify_pixel_validation","web_pixels_prefetch_assets","web_pixels_manager_runtime_asset_prefix","web_pixels_async_pixel_refactor"],webPixelsConfigList: [{"id":"shopify-app-pixel","configuration":"{}","eventPayloadVersion":"v1","runtimeContext":"STRICT","scriptVersion":"0544","apiClientId":"shopify-pixel","type":"APP"},{"id":"shopify-custom-pixel","eventPayloadVersion":"v1","runtimeContext":"LAX","scriptVersion":"0544","apiClientId":"shopify-pixel","type":"CUSTOM"}],initData: {"cart":null,"checkout":null,"customer":null,"productVariants":[]},},function pageEvents(webPixelsManagerAPI) {webPixelsManagerAPI.publish("page_viewed");webPixelsManagerAPI.publish("collection_viewed", {"collection":{"id":"156191916095","title":"Camera","productVariants":[{"id":"31374865629247","image":{"src":"https:\/\/cdn.shopify.com\/s\/files\/1\/0257\/0492\/3199\/products\/38.jpg?v=1575011477"},"price":{"amount":100.0,"currencyCode":"INR"},"product":{"id":"4397844955199","title":"BL Go PLUS Bluetooth Speaker","untranslatedTitle":"BL Go PLUS Bluetooth Speaker","vendor":"webi","type":"Camera"},"sku":"","title":"Blue","untranslatedTitle":"Blue"},{"id":"31374910324799","image":{"src":"https:\/\/cdn.shopify.com\/s\/files\/1\/0257\/0492\/3199\/products\/45.jpg?v=1575011947"},"price":{"amount":450.0,"currencyCode":"INR"},"product":{"id":"4397860585535","title":"Bajaj GX1 500 W Camera","untranslatedTitle":"Bajaj GX1 500 W Camera","vendor":"Demo","type":"Camera"},"sku":"","title":"Blue","untranslatedTitle":"Blue"},{"id":"39636973879359","image":{"src":"https:\/\/cdn.shopify.com\/s\/files\/1\/0257\/0492\/3199\/products\/14_bf0759e6-9a83-402e-a87a-c7c9ca796441.jpg?v=1575011285"},"price":{"amount":350.0,"currencyCode":"INR"},"product":{"id":"4397838598207","title":"15 Core I5 8th Gen LED TV","untranslatedTitle":"15 Core I5 8th Gen LED TV","vendor":"Demo","type":"Television"},"sku":"","title":"Black","untranslatedTitle":"Black"},{"id":"39636975550527","image":{"src":"https:\/\/cdn.shopify.com\/s\/files\/1\/0257\/0492\/3199\/products\/9.jpg?v=1575011120"},"price":{"amount":550.0,"currencyCode":"INR"},"product":{"id":"4397828571199","title":"RDP smart laptops","untranslatedTitle":"RDP smart laptops","vendor":"Dell","type":"Laptop"},"sku":"","title":"Gray","untranslatedTitle":"Gray"},{"id":"31374808023103","image":{"src":"https:\/\/cdn.shopify.com\/s\/files\/1\/0257\/0492\/3199\/products\/1_2d88be7f-cd06-4a67-b305-8a89a6cf836d.jpg?v=1575010861"},"price":{"amount":370.0,"currencyCode":"INR"},"product":{"id":"4397823623231","title":"Over-Ear USB Headset","untranslatedTitle":"Over-Ear USB Headset","vendor":"webi","type":"Head Phone"},"sku":"","title":"White","untranslatedTitle":"White"},{"id":"31374782693439","image":{"src":"https:\/\/cdn.shopify.com\/s\/files\/1\/0257\/0492\/3199\/products\/35.jpg?v=1575010481"},"price":{"amount":180.0,"currencyCode":"INR"},"product":{"id":"4397811597375","title":"Smartphone 16GB Blue","untranslatedTitle":"Smartphone 16GB Blue","vendor":"Demo","type":"Smart"},"sku":"","title":"s \/ Red","untranslatedTitle":"s \/ Red"},{"id":"31374879195199","image":{"src":"https:\/\/cdn.shopify.com\/s\/files\/1\/0257\/0492\/3199\/products\/32.jpg?v=1575011635"},"price":{"amount":350.0,"currencyCode":"INR"},"product":{"id":"4397850787903","title":"Wireless Z Bluetooth Headset","untranslatedTitle":"Wireless Z Bluetooth Headset","vendor":"webi","type":"Speaker"},"sku":"","title":"Black","untranslatedTitle":"Black"},{"id":"31374942371903","image":{"src":"https:\/\/cdn.shopify.com\/s\/files\/1\/0257\/0492\/3199\/products\/43.jpg?v=1575012579"},"price":{"amount":350.0,"currencyCode":"INR"},"product":{"id":"4397875429439","title":"Bajaj 17 L Solo Microwave Oven","untranslatedTitle":"Bajaj 17 L Solo Microwave Oven","vendor":"Demo","type":"Speaker"},"sku":"","title":"Pink","untranslatedTitle":"Pink"},{"id":"31374755594303","image":{"src":"https:\/\/cdn.shopify.com\/s\/files\/1\/0257\/0492\/3199\/products\/4.jpg?v=1575009824"},"price":{"amount":50.0,"currencyCode":"INR"},"product":{"id":"4394542530623","title":"BoAt Rockerz 400 Bluetooth Headset","untranslatedTitle":"BoAt Rockerz 400 Bluetooth Headset","vendor":"storego-demo","type":"Head Phone"},"sku":"","title":"Gray","untranslatedTitle":"Gray"}]}});},"https:https://cdn.shopify.com","browser","0.0.315","84e87a71wff12d2bfp19382293m9873e283",["web_pixels_use_shop_domain_monorail_endpoint","web_pixels_shopify_pixel_validation","web_pixels_prefetch_assets","web_pixels_manager_runtime_asset_prefix","web_pixels_async_pixel_refactor"]);</script>  <script>window['GoogleAnalyticsObject'] = 'ga';
...
var meta = {"products":[{"id":4397844955199,"gid":"gid:\/\/shopify\/Product\/4397844955199","vendor":"webi","type":"Camera","variants":[{"id":31374865629247,"price":10000,"name":"BL Go PLUS Bluetooth Speaker - Blue","public_title":"Blue","sku":""},{"id":31374865662015,"price":10000,"name":"BL Go PLUS Bluetooth Speaker - Gray","public_title":"Gray","sku":""}]},{"id":4397860585535,"gid":"gid:\/\/shopify\/Product\/4397860585535","vendor":"Demo","type":"Camera","variants":[{"id":31374910324799,"price":45000,"name":"Bajaj GX1 500 W Camera - Blue","public_title":"Blue","sku":""},{"id":31374910390335,"price":45000,"name":"Bajaj GX1 500 W Camera - Pink","public_title":"Pink","sku":""}]},{"id":4397838598207,"gid":"gid:\/\/shopify\/Product\/4397838598207","vendor":"Demo","type":"Television","variants":[{"id":39636973879359,"price":35000,"name":"15 Core I5 8th Gen LED TV - Black","public_title":"Black","sku":""},{"id":39636973912127,"price":35000,"name":"15 Core I5 8th Gen LED TV - Blue","public_title":"Blue","sku":""}]},{"id":4397828571199,"gid":"gid:\/\/shopify\/Product\/4397828571199","vendor":"Dell","type":"Laptop","variants":[{"id":39636975550527,"price":55000,"name":"RDP smart laptops - Gray","public_title":"Gray","sku":""},{"id":39636975583295,"price":55000,"name":"RDP smart laptops - Blue","public_title":"Blue","sku":""}]},{"id":4397823623231,"gid":"gid:\/\/shopify\/Product\/4397823623231","vendor":"webi","type":"Head Phone","variants":[{"id":31374808023103,"price":37000,"name":"Over-Ear USB Headset - White","public_title":"White","sku":""},{"id":31374808055871,"price":32000,"name":"Over-Ear USB Headset - Black","public_title":"Black","sku":""},{"id":31374808088639,"price":42000,"name":"Over-Ear USB Headset - Pink","public_title":"Pink","sku":""}]},{"id":4397811597375,"gid":"gid:\/\/shopify\/Product\/4397811597375","vendor":"Demo","type":"Smart","variants":[{"id":31374782693439,"price":18000,"name":"Smartphone 16GB Blue - s \/ Red","public_title":"s \/ Red","sku":""},{"id":31374782758975,"price":18000,"name":"Smartphone 16GB Blue - s \/ Blue","public_title":"s \/ Blue","sku":""},{"id":31374782824511,"price":18000,"name":"Smartphone 16GB Blue - s \/ Purple","public_title":"s \/ Purple","sku":""},{"id":39983737176127,"price":18000,"name":"Smartphone 16GB Blue - m \/ Red","public_title":"m \/ Red","sku":""},{"id":39983737208895,"price":18000,"name":"Smartphone 16GB Blue - m \/ Blue","public_title":"m \/ Blue","sku":""},{"id":39983737241663,"price":18000,"name":"Smartphone 16GB Blue - m \/ Purple","public_title":"m \/ Purple","sku":""}]},{"id":4397850787903,"gid":"gid:\/\/shopify\/Product\/4397850787903","vendor":"webi","type":"Speaker","variants":[{"id":31374879195199,"price":35000,"name":"Wireless Z Bluetooth Headset - Black","public_title":"Black","sku":""},{"id":31374879227967,"price":35000,"name":"Wireless Z Bluetooth Headset - Gray","public_title":"Gray","sku":""}]},{"id":4397875429439,"gid":"gid:\/\/shopify\/Product\/4397875429439","vendor":"Demo","type":"Speaker","variants":[{"id":31374942371903,"price":35000,"name":"Bajaj 17 L Solo Microwave Oven - Pink","public_title":"Pink","sku":""},{"id":31374942437439,"price":35000,"name":"Bajaj 17 L Solo Microwave Oven - Blue","public_title":"Blue","sku":""},{"id":31374942502975,"price":35000,"name":"Bajaj 17 L Solo Microwave Oven - Black","public_title":"Black","sku":""}]},{"id":4394542530623,"gid":"gid:\/\/shopify\/Product\/4394542530623","vendor":"storego-demo","type":"Head Phone","variants":[{"id":31374755594303,"price":5000,"name":"BoAt Rockerz 400 Bluetooth Headset - Gray","public_title":"Gray","sku":""},{"id":31374755627071,"price":5000,"name":"BoAt Rockerz 400 Bluetooth Headset - Pink","public_title":"Pink","sku":""},{"id":31374755659839,"price":5000,"name":"BoAt Rockerz 400 Bluetooth Headset - Black","public_title":"Black","sku":""}]}],"page":{"pageType":"collection","resourceType":"collection","resourceId":156191916095}};
...
<script class="analytics">(function () {
    ...
    trekkie.ready(function() {
      ...
      window.ShopifyAnalytics.lib.page(null,{"pageType":"collection","resourceType":"collection","resourceId":156191916095});

      var match = window.location.pathname.match(/checkouts\/(.+)\/(thank_you|post_purchase)/)
      var token = match? match[1]: undefined;
      if (!hasLoggedConversion(token)) {
        setCookieIfConversion(token);
        window.ShopifyAnalytics.lib.track("Viewed Product Category",{"currency":"INR","category":"Collection: camera","collectionName":"camera","collectionId":156191916095,"nonInteraction":true});
      }
    });
...
<p class="announcement-bar__message" style="color: #ffffff;">
            ...
            <div class="col-md-6 text-right headtleft">
              <localization-form><form method="post" action="/localization" id="FooterCountryForm" accept-charset="UTF-8" class="localization-form" enctype="multipart/form-data"><input type="hidden" name="form_type" value="localization" /><input type="hidden" name="utf8" value="?" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="return_to" value="/collections/camera" /><div class="no-js-hidden">
    ...
    <path d="M376.267,438.298c0.85,0,1.983,0,2.833,0c10.2-0.85,19.55-5.383,26.35-13.317c6.8-7.65,9.917-17.567,9.35-28.05
      ...
      C339.433,422.431,356.15,438.298,376.267,438.298z"></path>
                    ...
                    <div class="wbwish">
                                ...
                                <a class="wishlist" href="cart.php" title="Wishlist"><svg viewBox="0 0 129 129">
  <path d="m121.6,40.1c-3.3-16.6-15.1-27.3-30.3-27.3-8.5,0-17.7,3.5-26.7,10.1-9.1-6.8-18.3-10.3-26.9-10.3-15.2,0-27.1,10.8-30.3,27.6-4.8,24.9 10.6,58 55.7,76 0.5,0.2 1,0.3 1.5,0.3 0.5,0 1-0.1 1.5-0.3 45-18.4 60.3-51.4 55.5-76.1zm-57,67.9c-39.6-16.4-53.3-45-49.2-66.3 2.4-12.7 11.2-21 22.3-21 7.5,0 15.9,3.6 24.3,10.5 1.5,1.2 3.6,1.2 5.1,0 8.4-6.7 16.7-10.2 24.2-10.2 11.1,0 19.8,8.1 22.3,20.7 4.1,21.1-9.5,49.6-49,66.3z"></path>
</svg><span class="wbaddwish">Add To Wishlist</span></a>
	...
	<nav class="breadcrumb row" role="navigation" aria-label="breadcrumbs">
		<div class="col-12">
			<a href="index.php" title="Home">Home</a>
                ...
                <div id="shopify-section-template--14270126161983__banner" class="shopify-section spaced-section--full-width"><link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-collection-hero.css?v=108723383406131304161645685321" rel="stylesheet" type="text/css" media="all" />

    <h1 class="heading text-left"><span class="visually-hidden">Collection: </span><span>Camera</span></h1><div class="row collection-hero"><div class="col-md-2 col-sm-12 col-12  collection-hero__image-container">
                    <img class="img-fluid mx-auto"
                    srcset="https://cdn.shopify.com/s/files/1/0257/0492/3199/collections/7.png?v=1575009502 150w"
                    src="https://cdn.shopify.com/s/files/1/0257/0492/3199/collections/7_750x.png?v=1575009502"
                    alt="Camera"
                    loading="lazy"
                    width="150"
                    height="150" >
                </div><div class="col-md-10 col-sm-12 col-12  collection-hero__text-wrapper"><div class="collection-hero__description rte"><span data-mce-fragment="1">Maecenas id nulla tempor, scelerisque velit at, porta tortor. Suspendisse ornare, mi vel egestas vehicula, neque ante iaculis lacus, ac maximus nisl ligula non turpis. Ut mattis, dolor et feugiat sodales, eros nibh viverra dui, eu luctus ex velit nec ipsum. Nullam nec mattis mauris. Cras non risus felis. Aenean et dignissim leo. Aenean placerat nisl quam, ac hendrerit elit placerat in. Quisque eu enim id mauris semper ullamcorper. In eu diam nulla.</span></div></div>
        </div>
</div><div id="shopify-section-template--14270126161983__product-grid" class="shopify-section collection-grid-section"><link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/template-collection.css?v=182898978363309370031645685353" rel="stylesheet" type="text/css" media="all" />
...
<link rel="preload" href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-rte.css?v=146918724777113224111645685329" as="style" onload="this.onload=null;this.rel='stylesheet'">
...
<div id="ProductGridContainer"><div class="collection "><link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-facets.css?v=7075794923473822161648299097" rel="stylesheet" type="text/css" media="all" />
                        <script src="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/facets.js?v=123462745317715690791645685335" defer="defer"></script>
                        <div id="main-collection-filters" data-id="template--14270126161983__product-grid">
...
<facet-remove class="active-facets__button-wrapper">
              <a href="/collections/camera" class="active-facets__button-remove underlined-link">
                <span>Clear all</span>
              </a>
            </facet-remove>
          </div>
          ...
          <div id="FacetsWrapperDesktop" class="facets__wrapper">
                <details id="Details-1-template--14270126161983__product-grid" class="disclosure-has-popup facets__disclosure js-filter" data-index="1" >
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.354.646a.5.5 0 00-.708 0L5 4.293 1.354.646a.5.5 0 00-.708.708l4 4a.5.5 0 00.708 0l4-4a.5.5 0 000-.708z" fill="currentColor">
                  ...
                  <div id="Facet-1-template--14270126161983__product-grid" class="facets__display">
                    <div class="facets__header">
                      <span class="facets__selected no-js-hidden">0 selected</span>
                      <facet-remove>
                        <a href="/collections/camera" class="facets__reset link underlined-link">
                          Reset
                        </a>
                      </facet-remove>
                    </div>
                ...
                <details id="Details-2-template--14270126161983__product-grid" class="disclosure-has-popup facets__disclosure js-filter" data-index="2" >
                  <summary class="facets__summary caption-large focus-offset">
                    <div>
                      <span>Price</span>
                      <svg aria-hidden="true" focusable="false" role="presentation" class="icon icon-caret" viewBox="0 0 10 6">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.354.646a.5.5 0 00-.708 0L5 4.293 1.354.646a.5.5 0 00-.708.708l4 4a.5.5 0 00.708 0l4-4a.5.5 0 000-.708z" fill="currentColor">
                  ...
                  <div id="Facet-2-template--14270126161983__product-grid" class="facets__display">
                ...
                <details id="Details-3-template--14270126161983__product-grid" class="disclosure-has-popup facets__disclosure js-filter" data-index="3" >
                  <summary class="facets__summary caption-large focus-offset">
                    <div>
                      <span>Color</span>
                      <svg aria-hidden="true" focusable="false" role="presentation" class="icon icon-caret" viewBox="0 0 10 6">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.354.646a.5.5 0 00-.708 0L5 4.293 1.354.646a.5.5 0 00-.708.708l4 4a.5.5 0 00.708 0l4-4a.5.5 0 000-.708z" fill="currentColor">
                  ...
                  <div id="Facet-3-template--14270126161983__product-grid" class="facets__display">
                    <div class="facets__header">
                      <span class="facets__selected no-js-hidden">0 selected</span>
                      <facet-remove>
                        <a href="/collections/camera" class="facets__reset link underlined-link">
                    ...
                    <ul class="facets__list list-unstyled" role="list"><li class="list-menu__item facets__item">
                          ...
                          <label for="Filter-Color-7" class="facet-checkbox">
                            ...
                            <input type="checkbox" style="background-color: White; z-index: unset"name="filter.v.option.color"
                              value="White"
                              id="Filter-Color-7"
                ...
                <details id="Details-4-template--14270126161983__product-grid" class="disclosure-has-popup facets__disclosure js-filter" data-index="4" >
                  <summary class="facets__summary caption-large focus-offset">
                    <div>
                      <span>Size</span>
                      <svg aria-hidden="true" focusable="false" role="presentation" class="icon icon-caret" viewBox="0 0 10 6">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.354.646a.5.5 0 00-.708 0L5 4.293 1.354.646a.5.5 0 00-.708.708l4 4a.5.5 0 00.708 0l4-4a.5.5 0 000-.708z" fill="currentColor">
                  ...
                  <div id="Facet-4-template--14270126161983__product-grid" class="facets__display">
                    <div class="facets__header">
                      <span class="facets__selected no-js-hidden">0 selected</span>
                      <facet-remove>
                        <a href="/collections/camera" class="facets__reset link underlined-link">
...
<noscript>
        ...
        <form id="FacetFiltersFormMobile" class="mobile-facets">
          <div class="mobile-facets__inner">
            ...
            <div class="mobile-facets__main">
                  <details id="Details-Mobile-1-template--14270126161983__product-grid" class="mobile-facets__details js-filter" data-index="mobile-1">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.354.646a.5.5 0 00-.708 0L5 4.293 1.354.646a.5.5 0 00-.708.708l4 4a.5.5 0 00.708 0l4-4a.5.5 0 000-.708z" fill="currentColor">
                    ...
                    <div id="FacetMobile-1-template--14270126161983__product-grid" class="mobile-facets__submenu">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M8.537.808a.5.5 0 01.817-.162l4 4a.5.5 0 010 .708l-4 4a.5.5 0 11-.708-.708L11.793 5.5H1a.5.5 0 010-1h10.793L8.646 1.354a.5.5 0 01-.109-.546z" fill="currentColor">
                      ...
                      <div class="no-js-hidden mobile-facets__footer">
                        <facet-remove class="mobile-facets__clear-wrapper">
                          <a href="/collections/camera" class="mobile-facets__clear underlined-link">Clear</a>
                        </facet-remove>
                  ...
                  <details id="Details-Mobile-2-template--14270126161983__product-grid" class="mobile-facets__details js-filter" data-index="mobile-2">
                    <summary class="mobile-facets__summary focus-inset">
                      <div>
                        <span>Price</span>
                        <span class="mobile-facets__arrow no-js-hidden"><svg viewBox="0 0 14 10" fill="none" aria-hidden="true" focusable="false" role="presentation" class="icon icon-arrow" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.354.646a.5.5 0 00-.708 0L5 4.293 1.354.646a.5.5 0 00-.708.708l4 4a.5.5 0 00.708 0l4-4a.5.5 0 000-.708z" fill="currentColor">
                    ...
                    <div id="FacetMobile-2-template--14270126161983__product-grid" class="mobile-facets__submenu">
                      <button class="mobile-facets__close-button link link--text focus-inset" aria-expanded="true" type="button">
                        <svg viewBox="0 0 14 10" fill="none" aria-hidden="true" focusable="false" role="presentation" class="icon icon-arrow" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M8.537.808a.5.5 0 01.817-.162l4 4a.5.5 0 010 .708l-4 4a.5.5 0 11-.708-.708L11.793 5.5H1a.5.5 0 010-1h10.793L8.646 1.354a.5.5 0 01-.109-.546z" fill="currentColor">
</svg>
                      ...
                      <p class="mobile-facets__info">The highest price is ? 550.00</p>
                  ...
                  <details id="Details-Mobile-3-template--14270126161983__product-grid" class="mobile-facets__details js-filter" data-index="mobile-3">
                    <summary class="mobile-facets__summary focus-inset">
                      <div>
                        <span>Color</span>                        
                        <span class="mobile-facets__arrow no-js-hidden"><svg viewBox="0 0 14 10" fill="none" aria-hidden="true" focusable="false" role="presentation" class="icon icon-arrow" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.354.646a.5.5 0 00-.708 0L5 4.293 1.354.646a.5.5 0 00-.708.708l4 4a.5.5 0 00.708 0l4-4a.5.5 0 000-.708z" fill="currentColor">
                    ...
                    <div id="FacetMobile-3-template--14270126161983__product-grid" class="mobile-facets__submenu">
                      <button class="mobile-facets__close-button link link--text focus-inset" aria-expanded="true" type="button">
                        <svg viewBox="0 0 14 10" fill="none" aria-hidden="true" focusable="false" role="presentation" class="icon icon-arrow" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M8.537.808a.5.5 0 01.817-.162l4 4a.5.5 0 010 .708l-4 4a.5.5 0 11-.708-.708L11.793 5.5H1a.5.5 0 010-1h10.793L8.646 1.354a.5.5 0 01-.109-.546z" fill="currentColor">
</svg>
                  ...
                  <details id="Details-Mobile-4-template--14270126161983__product-grid" class="mobile-facets__details js-filter" data-index="mobile-4">
                    <summary class="mobile-facets__summary focus-inset">
                      <div>
                        <span>Size</span>                        
                        <span class="mobile-facets__arrow no-js-hidden"><svg viewBox="0 0 14 10" fill="none" aria-hidden="true" focusable="false" role="presentation" class="icon icon-arrow" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.354.646a.5.5 0 00-.708 0L5 4.293 1.354.646a.5.5 0 00-.708.708l4 4a.5.5 0 00.708 0l4-4a.5.5 0 000-.708z" fill="currentColor">
                    ...
                    <div id="FacetMobile-4-template--14270126161983__product-grid" class="mobile-facets__submenu">
                      <button class="mobile-facets__close-button link link--text focus-inset" aria-expanded="true" type="button">
                        <svg viewBox="0 0 14 10" fill="none" aria-hidden="true" focusable="false" role="presentation" class="icon icon-arrow" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M8.537.808a.5.5 0 01.817-.162l4 4a.5.5 0 010 .708l-4 4a.5.5 0 11-.708-.708L11.793 5.5H1a.5.5 0 010-1h10.793L8.646 1.354a.5.5 0 01-.109-.546z" fill="currentColor">
</svg>
...
<div class="mobile-facets__details js-filter" data-index="mobile-">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.354.646a.5.5 0 00-.708 0L5 4.293 1.354.646a.5.5 0 00-.708.708l4 4a.5.5 0 00.708 0l4-4a.5.5 0 000-.708z" fill="currentColor">
                ...
                <facet-remove class="mobile-facets__clear-wrapper">
                  <a href="/collections/camera" class="mobile-facets__clear underlined-link">Clear all</a>
                </facet-remove>
                <button type="button" class="no-js-hidden button button--primary" onClick="this.closest('.mobile-facets__wrapper').querySelector('summary').click()">Apply</button>
                <noscript><button class="button button--primary">Apply</button></noscript>
              </div>
...
<div class="wbcatsort col-md-9 col-7"><facet-filters-form class="small-hide">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.354.646a.5.5 0 00-.708 0L5 4.293 1.354.646a.5.5 0 00-.708.708l4 4a.5.5 0 00.708 0l4-4a.5.5 0 000-.708z" fill="currentColor">
                        ...
                        <ul id="product-grid" data-id="template--14270126161983__product-grid" class="row rless grid product-grid">
						
		<?php 	
		
		
		/*In this code, we're using the ternary operator to check if the 'category_id' parameter is set in the URL. If it is set, the value will be assigned to the $id1 variable; otherwise, the variable will be assigned null. This way, you avoid any potential errors when the parameter is not present in the URL.*/	

		
$id1 = isset($_GET['category_id']) ? $_GET['category_id'] : null;
		
$get_users="select * from `add_product` where category='".$id1."'";
$result=mysqli_query($conn,$get_users);				
...
$discription= $show_users["discription"];		
	...
	$get_users123="SELECT * FROM `multiple_images` order by product_id='".$product_id."' desc limit 1";
	$result123=mysqli_query($conn,$get_users123);
 	while($row123=mysqli_fetch_assoc($result123)){
	$image_id= $row123["image_id"];
	$image_name= $row123["image_name"];
	}
...
<div class="card-wrapper wbproduct-container">
	<div class="card">
      <div class="wbimgblock">
              <div id="webipro-template--14270126161983__product-grid-4397860585535" class="card__media"><div class="product__media-item" data-media-id="template--14270126161983__product-grid-4397860585535-5824692715583">
                          <a href="/products/bajaj-gx1-500-w-camera" title="Bajaj GX1 500 W Camera" class="media media--transparent media--adapt media--hover-effect "  style="padding-bottom: 100.0%;">
                              <img class="img-fluid mx-auto" 
                      ...
                      </div><div class="product__media-item" data-media-id="template--14270126161983__product-grid-4397860585535-5824692748351">
                              <a href="/products/bajaj-gx1-500-w-camera" title="Bajaj GX1 500 W Camera" class="media media--transparent media--adapt media--hover-effect "  style="padding-bottom: 100.0%;">
                                  <img class="img-fluid mx-auto"
                                  srcset="https://storego-demo.myshopify.com/cdn/shop/products/46_493x.jpg?v=1575011947 493w,
                                        https://storego-demo.myshopify.com/cdn/shop/products/46_600x.jpg?v=1575011947 600w,
                                        https://storego-demo.myshopify.com/cdn/shop/products/46_713x.jpg?v=1575011947 713w,
                                        https://storego-demo.myshopify.com/cdn/shop/products/46_823x.jpg?v=1575011947 823w,
                                        https://storego-demo.myshopify.com/cdn/shop/products/46_992x.jpg?v=1575011947 992w,
                                        ...
                                        https://storego-demo.myshopify.com/cdn/shop/products/46.jpg?v=1575011947 1000w"
                                  src="https://storego-demo.myshopify.com/cdn/shop/products/46_370x.jpg?v=1575011947 370w"
                                  sizes="(min-width: 1600px) 0px, (min-width: 992px) calc(0vw - 10rem), (min-width: 768px) calc((100vw - 11.5rem) / 2), calc(100vw - 4rem)"
                                  loading="lazy"
                                  width="1000"
                                  height="1000"
...
<h3 class="product-title"><a href="" ><?php echo $product_title; ?></a></h3>
        <span class="caption-large light"></span><p class="wblistpdesc">
               <?php echo $discription; ?>
            </p><div id="ProductInfo-template--14270126161983__product-grid-4397860585535" ><div class="wbhrating">
                    ...
                    </div><div class="no-js-hidden wbhprice" id="price-template--14270126161983__product-grid-4397860585535" role="status" >
<div class="price price--on-sale ">
  <div class="price__container"><div class="price__regular">
      <span class="visually-hidden visually-hidden--inline">Regular price</span>
      <span class="price-item price-item--regular">
...
<variant-radios class="no-js-hidden new-swatch variant-webi" data-section="template--14270126161983__product-grid" data-product="4397860585535" data-url="/products/bajaj-gx1-500-w-camera" data-update-url="false" data-layout="card" ><fieldset  class="swatchComponent inner-class" >
                                    <div  class="wbswatchclr" ><input type="radio" id="template--14270126161983__product-grid-4397860585535-1-0"
                                            name="Color"
                                            value="Blue"
                                            aria-label="Options"
                                            form="product-form-template--14270126161983__product-grid-4397860585535"
                                            checked>

                                            
<label class="color-swatchimg color-swatch  active" for="template--14270126161983__product-grid-4397860585535-1-0" data-val="Blue"
                                                style="background-color: blue;  background-image: url(https://storego-demo.myshopify.com/cdn/shop/files/blue_50x50.png);"></label>
                                            
                                        <input type="radio" id="template--14270126161983__product-grid-4397860585535-1-1"
                                            name="Color"
                                            value="Pink"
                                            aria-label="Options"
                                            form="product-form-template--14270126161983__product-grid-4397860585535"
...
<label class="color-swatchimg color-swatch " for="template--14270126161983__product-grid-4397860585535-1-1" data-val="Pink"
                                                style="background-color: pink;  background-image: url(https://storego-demo.myshopify.com/cdn/shop/files/pink_50x50.png);"></label>
                                            
                                        
                                    </div>
                                </fieldset>
                            <script type="application/json">
                                [{"id":31374910324799,"title":"Blue","option1":"Blue","option2":null,"option3":null,"sku":"","requires_shipping":true,"taxable":true,"featured_image":{"id":13658524680255,"product_id":4397860585535,"position":1,"created_at":"2019-11-29T02:19:07-05:00","updated_at":"2019-11-29T02:19:07-05:00","alt":null,"width":1000,"height":1000,"src":"\/\/storego-demo.myshopify.com\/cdn\/shop\/products\/45.jpg?v=1575011947","variant_ids":[31374910324799]},"available":true,"name":"Bajaj GX1 500 W Camera - Blue","public_title":"Blue","options":["Blue"],"price":45000,"weight":0,"compare_at_price":65000,"inventory_management":"shopify","barcode":"","featured_media":{"alt":null,"id":5824692715583,"position":1,"preview_image":{"aspect_ratio":1.0,"height":1000,"width":1000,"src":"\/\/storego-demo.myshopify.com\/cdn\/shop\/products\/45.jpg?v=1575011947"}},"quantity_rule":{"min":1,"max":null,"increment":1}},{"id":31374910390335,"title":"Pink","option1":"Pink","option2":null,"option3":null,"sku":"","requires_shipping":true,"taxable":true,"featured_image":{"id":13658524713023,"product_id":4397860585535,"position":2,"created_at":"2019-11-29T02:19:07-05:00","updated_at":"2019-11-29T02:19:07-05:00","alt":null,"width":1000,"height":1000,"src":"\/\/storego-demo.myshopify.com\/cdn\/shop\/products\/46.jpg?v=1575011947","variant_ids":[31374910390335]},"available":true,"name":"Bajaj GX1 500 W Camera - Pink","public_title":"Pink","options":["Pink"],"price":45000,"weight":0,"compare_at_price":null,"inventory_management":"shopify","barcode":"","featured_media":{"alt":null,"id":5824692748351,"position":2,"preview_image":{"aspect_ratio":1.0,"height":1000,"width":1000,"src":"\/\/storego-demo.myshopify.com\/cdn\/shop\/products\/46.jpg?v=1575011947"}},"quantity_rule":{"min":1,"max":null,"increment":1}}]
                            </script>
                        </variant-radios><select name="id" id="Variants-template--14270126161983__product-grid-4397860585535" class="select__select no-js" form="product-form-template--14270126161983__product-grid-4397860585535"><option data-v-title="Blue"
                    data-unitprice=""
                    data-unitvalue=""
                    data-price="₹ 450.00"
                    data-cprice="₹ 650.00" 
...
<form method="post" action="products.php" id="product-form-template--14270126161983__product-grid-4397860585535" accept-charset="UTF-8" class="form" enctype="multipart/form-data" novalidate="novalidate" data-type="add-to-cart-form"><input type="hidden" name="form_type" value="product" /><input type="hidden" name="utf8" value="✓" /><input type="hidden" name="id" value="31374910324799" disabled>
   <a type="submit" name="add" class="cartb product-form__submit button"   href="products.php?cart_added=<?php echo $product_id; ?>">
  ...
  <path d="M17,55.231h48.733l69.417,251.033c1.983,7.367,8.783,12.467,16.433,12.467h213.35c6.8,0,12.75-3.967,15.583-10.2
    ...
    <path d="M376.267,438.298c0.85,0,1.983,0,2.833,0c10.2-0.85,19.55-5.383,26.35-13.317c6.8-7.65,9.917-17.567,9.35-28.05
      c-1.417-20.967-19.833-37.117-41.083-35.7c-21.25,1.417-37.117,20.117-35.7,41.083
      C339.433,422.431,356.15,438.298,376.267,438.298z"></path>
</svg></a><div class="loading-overlay__spinner hidden">
                                <svg aria-hidden="true" focusable="false" role="presentation" class="spinner" viewBox="0 0 66 66" xmlns="http://www.w3.org/2000/svg">
                                <circle class="path" fill="none" stroke-width="6" cx="33" cy="33" r="30"></circle>
                                </svg>
                            </div>
                    ...
                    <div class="wbwish">
                                ...
                                <a class="wishlist"  href="products.php?add_to_wishlist=<?php echo $product_id; ?>" title="Wishlist"><svg viewBox="0 0 129 129">
  <path d="m121.6,40.1c-3.3-16.6-15.1-27.3-30.3-27.3-8.5,0-17.7,3.5-26.7,10.1-9.1-6.8-18.3-10.3-26.9-10.3-15.2,0-27.1,10.8-30.3,27.6-4.8,24.9 10.6,58 55.7,76 0.5,0.2 1,0.3 1.5,0.3 0.5,0 1-0.1 1.5-0.3 45-18.4 60.3-51.4 55.5-76.1zm-57,67.9c-39.6-16.4-53.3-45-49.2-66.3 2.4-12.7 11.2-21 22.3-21 7.5,0 15.9,3.6 24.3,10.5 1.5,1.2 3.6,1.2 5.1,0 8.4-6.7 16.7-10.2 24.2-10.2 11.1,0 19.8,8.1 22.3,20.7 4.1,21.1-9.5,49.6-49,66.3z"></path>
</svg><span class="wbaddwish">Add To Wishlist</span></a>
                    ...
                    <div class="wbqvtop">
					<a href="singleproduct.php?product_view=<?php echo $product_id; ?>">
       <button class="focus-inset wbquickv quick_shop js-wbquickview-link" aria-label="Quick view" data-id="4397860585535" data-url="/products/bajaj-gx1-500-w-camera">
