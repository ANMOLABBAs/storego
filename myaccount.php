...
if(isset($_REQUEST['delete_order'])){
 ...
 $order_id_del=$_GET['delete_order'];

$delete_order="DELETE FROM `order_details` WHERE `order_id`='".$order_id_del."' ";
...
<div class="customer account">
    <h1 class="heading text-left"><span>Account</span></h1>
    <div class="wbordhis">
      <h2>Order history</h2>
	...
	<div style="width:100%;overflow:hidden;border:1px solid #333333;">
		...
		<div style="width:12%;float:left;overflow:hidden; border: 1px solid #333333;padding:5px;font-size:15px;text-align:center;">Address</div>
		...
		<div style="width:13%;float:left;overflow:hidden; border: 1px solid #333333;padding:5px;font-size:15px;text-align:center;">Date</div>
		<div style="width:10%;float:left;overflow:hidden; border: 1px solid #333333;padding:5px;font-size:15px;text-align:center;">View</div>
		 <div style="width:10%;float:left;overflow:hidden; border: 1px solid #333333;padding:5px;font-size:15px;text-align:center;">Delete</div>

	</div>      

<?php 

	$get_users2="SELECT * FROM `order_details` where user_id='".$_SESSION['login_username_id']."'";
	$result2=mysqli_query($conn,$get_users2);

	while($row2=mysqli_fetch_assoc($result2)){
	
	$first_name123=$row2['first_name'];
	$last_name123=$row2['last_name'];	
	$order_id123=$row2['order_id']; 
	$address123=$row2['address'];
	$city123=$row2['city'];	
 	$phone123=$row2['phone'];
 	$total_price123=$row2['total_price'];
 	$date123=$row2['date'];
 	$status123=$row2['status'];

	$get_status_data="SELECT * FROM `status_order` where status='".$status123."'";
	$get_status_data_results=mysqli_query($conn,$get_status_data);

	while($get_status_data_row=mysqli_fetch_assoc($get_status_data_results)){
	
	$order_status_id123=$get_status_data_row['status_id'];
...
width:10%;float:left;overflow:hidden; border: 1px solid #333333;padding:5px;font-size:10px;text-align:center;
	...
	<div style="width:100%;overflow:hidden;border:1px solid #333333;margin-top:-1px;">
		<div style="width:8%;float:left;overflow:hidden; border: 1px solid #333333;padding:5px;font-size:10px;text-align:center;"><?php echo $order_id123; ?></div>
		<div style="width:10%;float:left;overflow:hidden; border: 1px solid #333333;padding:5px;font-size:10px;text-align:center;"><?php echo $first_name123;  ?> 
		<?php echo $last_name123; ?></div>
		<div style="width:20%;float:left;overflow:hidden; border: 1px solid #333333;padding:5px;font-size:10px;text-align:center;"><?php echo $address123;  ?> 
		<?php echo $city123; ?></div>
		<div style="width:12%;float:left;overflow:hidden; border: 1px solid #333333;padding:5px;font-size:10px;text-align:center;"><?php echo $phone123; ?></div>
		<div style="width:10%;float:left;overflow:hidden; border: 1px solid #333333;padding:5px;font-size:10px;text-align:center;">$ <?php echo $total_price123; ?></div>
		<div class="status_main" <?php if($order_status_id123=='3'){?> style="color:#FF0000;"<?php }?><?php if($order_status_id123=='4'){?> style="color:#00FF33;"<?php }?><?php if($order_status_id123=='2'){?> style="color:#0000FF;"<?php }?> <?php if($order_status_id123=='1'){?> style="color:#FFCC00;"<?php }?>><?php echo $status123; ?></div>
		<div style="width:13%;float:left;overflow:hidden;height:27px;padding-top:5px; border: 1px solid #333333;font-size:8px;text-align:center;"><?php echo $date123; ?></div>
		<div style="width:7%;float:left;overflow:hidden; border: 1px solid #333333;padding:5px;font-size:10px;text-align:center;"><a href="thanks.php?order_id=<?php echo $order_id123; ?>">View</a></div>
		<div style="width:10%;float:left;overflow:hidden; border: 1px solid #333333;padding:5px;font-size:10px;text-align:center;"><a href="myaccount.php?delete_order=<?php echo $order_id123; ?>">Delete</a></div>
...
$select_users="SELECT * FROM `users_details` where user_id='".$_SESSION['login_username_id']."' ";
...
?>
    <div>
      ...
      <p><?php echo $first_name; ?>&nbsp;<?php echo $last_name; ?><br>Email : <?php echo $email; ?></p>

      <a href="myaccountaddress.php" class="btn btn-primary">View addresses (1)</a>
      <a href="?logout=1" class="btn btn-primary">Log out</a>
    </div>
