...
if (isset($_REQUEST['signup'])) {
  ...
  $insert_user = "INSERT INTO `users_details` (`user_id`, `first_name`, `last_name`, `email`, `password`, `phone_no`, `user_type`, `login_user`) VALUES (NULL, '".$first_name."', '".$last_name."', '".$email."', '".$password."', 'user', '1')";
...
<html class="no-js wbboxlt" lang="en" >
  <head>
    ...
    <link rel="canonical" href="https://storego-demo.myshopify.com/account/register">
...
<meta property="og:url" content="https://storego-demo.myshopify.com/account/register">
...
<link rel="alternate" hreflang="x-default" href="https://storego-demo.myshopify.com/account/register">
<link rel="alternate" hreflang="en-IN" href="https://storego-demo.myshopify.com/account/register">
<link rel="alternate" hreflang="ar-IN" href="https://storego-demo.myshopify.com/ar/account/register">
<link rel="alternate" hreflang="en-US" href="https://storego-demo.myshopify.com/en-us/account/register">
<link rel="alternate" hreflang="ar-US" href="https://storego-demo.myshopify.com/ar-us/account/register">
<script>
  (function() {
...
<script id="__st">var __st={"a":25704923199,"offset":-14400,"reqid":"d49baf8a-7d39-4ac2-837d-6e004cae7a16","pageurl":"storego-demo.myshopify.com\/account\/register","u":"00670d020a1e"};</script>
...
<script async="async" src="https://www.google-analytics.com/analytics.js"></script>
  ...
  <body class="gradient template-customers-register">
...
<div class="customer register col-md-6 col-12">
  ...
  <form method="post" action="signup.php" id="create_customer" accept-charset="UTF-8" data-login-with-shop-sign-up="true" novalidate="novalidate">
  ...
  <div class="field">   
      ...
      <input type="text" name="first_name" id="RegisterForm-FirstName" autocomplete="given-name" placeholder="First name" autofill="off" required />
      <label for="RegisterForm-FirstName">
        First name
      </label>
    </div>
    <div class="field">
      <input type="text" name="last_name" id="RegisterForm-LastName" autocomplete="family-name" placeholder="Last name" autofill="off" required />
      <label for="RegisterForm-LastName">
        Last name
      </label>
    </div>
    <div class="field">      
     <input type="email" name="email" id="RegisterForm-email" spellcheck="false" autocapitalize="off"  autocomplete="email" aria-required="true" cplaceholder="Email" autofill="off" required />
      <label for="RegisterForm-email">
        Email
      </label>
    </div><div class="field">     
      <input type="password" name="password" id="RegisterForm-password" aria-required="true" placeholder="Password" autofill="off" required />
      <label for="RegisterForm-password">
        Password
      </label>
    </div>
	<div class="field">     
      <input type="text" name="phone_no" id="RegisterForm-password" aria-required="true" placeholder="Contact No" autofill="off" required />
      <label for="RegisterForm-password">
        Password
      </label>
    </div>
	<input class="botton" type="submit" value="Creat" name="signup" >
    </form>
</div>
</div>
</div>
