...
if (isset($_REQUEST['submit_review'])) {
     ...
     echo $get_review="SELECT * FROM `product_reviews` where user_id='".$_SESSION['login_username_id']."' and product_id='".$_REQUEST['product_view']."'";
	$result_review=mysqli_query($conn,$get_review);
	$rowcount_review=mysqli_num_rows($result_review);

echo $rowcount_review;
$product_id_top=$_REQUEST['product_id_top'];

	if (isset($rowcount_review)>0) {


		header("location:singleproduct.php?product_view=".$product_id_top."");
...
$rating_stars=$_REQUEST['rating_star'];

$insert_review="INSERT INTO `product_reviews`(`reviews_id`, `product_id`, `user_id`, `number_of_reviews`, `comment`) VALUES (NULL,'".$product_id_top."','".$_SESSION['login_username_id']."','".$rating_stars."','".$comments."')";
...
if (isset($_REQUEST['cart_added'])) {
 
echo $single_pro_id = $_REQUEST['single_pro_id'];
	$quantity_update=$_REQUEST['quantity'];

echo $get_users="select * from add_cart where product_id='".$single_pro_id."'";
...
$insert_cart="UPDATE `add_cart` SET `quantity` = '".$quantity_update."' WHERE `product_id` = ".$single_pro_id."";
...
$insert_cart="INSERT INTO `add_cart` (`cart_id` ,`product_id` ,`user_id`,`quantity`)VALUES (NULL , '".$single_pro_id."', '".$_SESSION['login_username_id']."','1');";
$conn->query($insert_cart);
header("location:cart.php");
}
 ...
 $product_id_get=$_GET['product_view'];

$incr_views="SELECT * FROM `product_views` WHERE  product_id='".$product_id_get."'";
$result_incr_views=mysqli_query($conn,$incr_views);
$rowcount_incr_views=mysqli_num_rows($result_incr_views);

while($row_incr_views=mysqli_fetch_assoc($result_incr_views)){

$views=$row_incr_views["views"];

$final_view=$views+1;

}

if ($rowcount_incr_views>0) {

$update_views="UPDATE `product_views` SET `views`='".$final_view."' WHERE product_id='".$product_id_get."'";
mysqli_query($conn,$update_views);

}else {

$insert_views="INSERT INTO `product_views`(`views_id`, `views`, `product_id`) VALUES (NULL,'1','".$product_id_get."')";
mysqli_query($conn,$insert_views);
...
<html class="no-js wbboxlt" lang="en" >
  <head>
    ...
    <link rel="canonical" href="https://storego-demo.myshopify.com/products/bl-go-plus-bluetooth-speaker">
    <link rel="preconnect" href="https:https://cdn.shopify.com" crossorigin><link rel="icon" type="image/png" href="https://cdn.shopify.com/s/files/1/0257/0492/3199/files/Favicon_a8c7c7e1-5312-4697-a323-8607cbd976f4_32x32.png?v=1657006073"><title>
      BL Go PLUS Bluetooth Speaker
 &ndash; storego-demo</title>

    
      <meta name="description" content="Vivamus quis pellentesque nisi. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi magna neque, finibus ut ultricies vitae, bibendum ut elit. Aliquam erat erat, egestas in dignissim at, bibendum at ante. Praesent dapibus aliquam dignissim. Aliquam rutrum bibendum posuere. Praesent pulvinar lobortis dui sit ">
    

    

<meta property="og:site_name" content="storego-demo">
<meta property="og:url" content="https://storego-demo.myshopify.com/products/bl-go-plus-bluetooth-speaker">
<meta property="og:title" content="BL Go PLUS Bluetooth Speaker">
<meta property="og:type" content="product">
<meta property="og:description" content="Vivamus quis pellentesque nisi. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi magna neque, finibus ut ultricies vitae, bibendum ut elit. Aliquam erat erat, egestas in dignissim at, bibendum at ante. Praesent dapibus aliquam dignissim. Aliquam rutrum bibendum posuere. Praesent pulvinar lobortis dui sit "><meta property="og:image" content="http:https://cdn.shopify.com/s/files/1/0257/0492/3199/products/37.jpg?v=1575011477">
  <meta property="og:image:secure_url" content="https:https://cdn.shopify.com/s/files/1/0257/0492/3199/products/37.jpg?v=1575011477">
  <meta property="og:image:width" content="1000">
  <meta property="og:image:height" content="1000"><meta property="og:price:amount" content="100.00">
  <meta property="og:price:currency" content="INR"><meta name="twitter:site" content="@#"><meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="BL Go PLUS Bluetooth Speaker">
<meta name="twitter:description" content="Vivamus quis pellentesque nisi. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi magna neque, finibus ut ultricies vitae, bibendum ut elit. Aliquam erat erat, egestas in dignissim at, bibendum at ante. Praesent dapibus aliquam dignissim. Aliquam rutrum bibendum posuere. Praesent pulvinar lobortis dui sit ">
...
<link rel="alternate" hreflang="x-default" href="https://storego-demo.myshopify.com/products/bl-go-plus-bluetooth-speaker">
<link rel="alternate" hreflang="en-IN" href="https://storego-demo.myshopify.com/products/bl-go-plus-bluetooth-speaker">
<link rel="alternate" hreflang="ar-IN" href="https://storego-demo.myshopify.com/ar/products/bl-go-plus-bluetooth-speaker">
<link rel="alternate" hreflang="en-US" href="https://storego-demo.myshopify.com/en-us/products/bl-go-plus-bluetooth-speaker">
<link rel="alternate" hreflang="ar-US" href="https://storego-demo.myshopify.com/ar-us/products/bl-go-plus-bluetooth-speaker">
<link rel="alternate" type="application/json+oembed" href="https://storego-demo.myshopify.com/products/bl-go-plus-bluetooth-speaker.oembed">
<script>
  (function() {
...
<script id="__st">var __st={"a":25704923199,"offset":-14400,"reqid":"6c11d206-b722-4d83-bc62-3cc21892f511","pageurl":"storego-demo.myshopify.com\/products\/bl-go-plus-bluetooth-speaker","u":"071f137fdc6a","p":"product","rtyp":"product","rid":4397844955199};</script>
...
<script id="sections-script" data-sections="main-product,product-recommendations,header" defer="defer" src="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/compiled_assets/scripts.js?10371"></script>
...
var meta = {"product":{"id":4397844955199,"gid":"gid:\/\/shopify\/Product\/4397844955199","vendor":"webi","type":"Camera","variants":[{"id":31374865629247,"price":10000,"name":"BL Go PLUS Bluetooth Speaker - Blue","public_title":"Blue","sku":""},{"id":31374865662015,"price":10000,"name":"BL Go PLUS Bluetooth Speaker - Gray","public_title":"Gray","sku":""}]},"page":{"pageType":"product","resourceType":"product","resourceId":4397844955199}};
...
<script class="analytics">(function () {
    ...
    trekkie.ready(function() {
      ...
      window.ShopifyAnalytics.lib.page(null,{"pageType":"product","resourceType":"product","resourceId":4397844955199});

      var match = window.location.pathname.match(/checkouts\/(.+)\/(thank_you|post_purchase)/)
      var token = match? match[1]: undefined;
      if (!hasLoggedConversion(token)) {
        setCookieIfConversion(token);
        window.ShopifyAnalytics.lib.track("Viewed Product",{"currency":"INR","variantId":31374865629247,"productId":4397844955199,"productGid":"gid:\/\/shopify\/Product\/4397844955199","name":"BL Go PLUS Bluetooth Speaker - Blue","price":"100.00","sku":"","brand":"webi","variant":"Blue","category":"Camera","nonInteraction":true});
      window.ShopifyAnalytics.lib.track("monorail:\/\/trekkie_storefront_viewed_product\/1.1",{"currency":"INR","variantId":31374865629247,"productId":4397844955199,"productGid":"gid:\/\/shopify\/Product\/4397844955199","name":"BL Go PLUS Bluetooth Speaker - Blue","price":"100.00","sku":"","brand":"webi","variant":"Blue","category":"Camera","nonInteraction":true,"referer":"https:\/\/storego-demo.myshopify.com\/products\/bl-go-plus-bluetooth-speaker"});
      }
    });
...
<p class="announcement-bar__message" style="color: #ffffff;">
            ...
            <div class="col-md-6 text-right headtleft">
              <localization-form><form method="post" action="/localization" id="FooterCountryForm" accept-charset="UTF-8" class="localization-form" enctype="multipart/form-data"><input type="hidden" name="form_type" value="localization" /><input type="hidden" name="utf8" value="?" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="return_to" value="/products/bl-go-plus-bluetooth-speaker" /><div class="no-js-hidden">
    ...
    <path d="M376.267,438.298c0.85,0,1.983,0,2.833,0c10.2-0.85,19.55-5.383,26.35-13.317c6.8-7.65,9.917-17.567,9.35-28.05
      ...
      C339.433,422.431,356.15,438.298,376.267,438.298z"></path>
                    ...
                    <div class="wbwish">
                                ...
                                <a class="wishlist" href="/account/login" title="Wishlist"><svg viewBox="0 0 129 129">
  <path d="m121.6,40.1c-3.3-16.6-15.1-27.3-30.3-27.3-8.5,0-17.7,3.5-26.7,10.1-9.1-6.8-18.3-10.3-26.9-10.3-15.2,0-27.1,10.8-30.3,27.6-4.8,24.9 10.6,58 55.7,76 0.5,0.2 1,0.3 1.5,0.3 0.5,0 1-0.1 1.5-0.3 45-18.4 60.3-51.4 55.5-76.1zm-57,67.9c-39.6-16.4-53.3-45-49.2-66.3 2.4-12.7 11.2-21 22.3-21 7.5,0 15.9,3.6 24.3,10.5 1.5,1.2 3.6,1.2 5.1,0 8.4-6.7 16.7-10.2 24.2-10.2 11.1,0 19.8,8.1 22.3,20.7 4.1,21.1-9.5,49.6-49,66.3z"></path>
</svg><span class="wbaddwish">Add To Wishlist</span></a>
  ...
  <path d="m121.6,40.1c-3.3-16.6-15.1-27.3-30.3-27.3-8.5,0-17.7,3.5-26.7,10.1-9.1-6.8-18.3-10.3-26.9-10.3-15.2,0-27.1,10.8-30.3,27.6-4.8,24.9 10.6,58 55.7,76 0.5,0.2 1,0.3 1.5,0.3 0.5,0 1-0.1 1.5-0.3 45-18.4 60.3-51.4 55.5-76.1zm-57,67.9c-39.6-16.4-53.3-45-49.2-66.3 2.4-12.7 11.2-21 22.3-21 7.5,0 15.9,3.6 24.3,10.5 1.5,1.2 3.6,1.2 5.1,0 8.4-6.7 16.7-10.2 24.2-10.2 11.1,0 19.8,8.1 22.3,20.7 4.1,21.1-9.5,49.6-49,66.3z"></path>
    ...
    <path d="M173.261,211.555c-1.626,5.329-2.507,10.982-2.507,16.843c0,31.834,25.807,57.642,57.642,57.642
      ...
      L173.261,211.555z"></path>
		...
		$id2=$_GET['product_view'];
		$select_single="select * from `add_product` where `product_id`='".$id2."'; ";
$result=mysqli_query($conn,$select_single);
$sr=0;
...
$product_id= $show_users["product_id"];
	...
	<nav class="breadcrumb row" role="navigation" aria-label="breadcrumbs">
		<div class="col-12">
			...
			<span><?php echo $product_title ?></span>
                ...
                <section id="shopify-section-template--14270126424127__main" class="shopify-section product-section">
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/section-main-product.css?v=153831906449012114361664959285" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-accordion.css?v=38177813546662810821645685319" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-price.css?v=75926142592083736931648449696" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-rte.css?v=146918724777113224111645685329" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-slider.css?v=77741885485310857371645685329" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-rating.css?v=149782489698461958261645685328" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-loading-overlay.css?v=28628663824550559871645685324" rel="stylesheet" type="text/css" media="all" />

<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/photoswipe.css?v=55313879938268225451645685342" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/default-skin.css?v=13623853025544460901645685332" rel="stylesheet" type="text/css" media="all" />

<link rel="stylesheet" href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-deferred-media.css?v=152743953507945798261645685322" media="print" onload="this.media='all'">

<script src="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/product-form.js?v=145274427960080480171645685344" defer="defer"></script>
...
<script src="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/photoswipe.min.js?v=17936596771345626681645685342"></script>
<script src="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/photoswipe-ui-default.min.js?v=41917543800960412131645685341"></script><section class="">
  <div class="product product--medium product--thumbnail_slider grid grid--1-col grid--2-col-tablet">
    <div class="grid__item product__media-wrapper wbproleftimg">
      <media-gallery id="MediaGallery-template--14270126424127__main" role="region" class="product__media-gallery" aria-label="Gallery Viewer" data-desktop-layout="thumbnail_slider">
        <div id="GalleryStatus-template--14270126424127__main" class="visually-hidden" role="status"></div>
        <slider-component id="GalleryViewer-template--14270126424127__main" class="slider-mobile-gutter">
          <a class="skip-to-content-link button visually-hidden" href="#ProductInfo-template--14270126424127__main">
            Skip to product information
          </a>
          <ul id="Slider-Gallery-template--14270126424127__main" class="product__media-list grid grid--peek list-unstyled slider slider--mobile" role="list"><li id="Slide-template--14270126424127__main-5824634093631" class="protopimg-item product__media-item grid__item slider__slide is-active" data-media-id="template--14270126424127__main-5824634093631">
...
<noscript><div class="product__media media" style="padding-top: 100.0%;">
      <img
        srcset="https://cdn.shopify.com/s/files/1/0257/0492/3199/products/38_493x.jpg?v=1575011477 493w,
          ...
          https://cdn.shopify.com/s/files/1/0257/0492/3199/products/38.jpg?v=1575011477 1000w"
        src="https://cdn.shopify.com/s/files/1/0257/0492/3199/products/38_1946x.jpg?v=1575011477"
...
<modal-opener class="product__modal-opener product__modal-opener--image no-js-hidden" data-modal="#ProductModal-template--14270126424127__main">
...
<?php 
	$show_images="SELECT * FROM `multiple_images` where  product_id='".$id2."'  limit 1 ";
  ...
  <div class="product__media media media--transparent" style="padding-top: 100.0%;">
    <img
      srcset="./admin/<?php echo 'admin_pics'; ?>/<?php echo $image_name; ?>"
      src="./admin/<?php echo 'admin_pics'; ?>/<?php echo $image_name; ?>"
      sizes="(min-width: 1600px) 825px, (min-width: 992px) calc(55.0vw - 10rem), (min-width: 768px) calc((100vw - 11.5rem) / 2), calc(100vw - 4rem)"
      loading="lazy"
      data-width="973"
      data-height="973"
...
<?php } ?>
  <button class="product__media-toggle" type="button" aria-haspopup="dialog" data-media-id="5824634093631">
    <span class="visually-hidden">
      Open media 1 in gallery view
    </span>
  </button>
</modal-opener>
              </li><li id="Slide-template--14270126424127__main-5824634060863" class="protopimg-item product__media-item grid__item slider__slide" data-media-id="template--14270126424127__main-5824634060863">
...
<noscript><div class="product__media media" style="padding-top: 100.0%;">
      <img
        srcset="https://cdn.shopify.com/s/files/1/0257/0492/3199/products/37_493x.jpg?v=1575011477 493w,
          ...
          https://cdn.shopify.com/s/files/1/0257/0492/3199/products/37.jpg?v=1575011477 1000w"
        src="https://cdn.shopify.com/s/files/1/0257/0492/3199/products/37_1946x.jpg?v=1575011477"
        sizes="(min-width: 1600px) 825px, (min-width: 992px) calc(55.0vw - 10rem), (min-width: 768px) calc((100vw - 11.5rem) / 2), calc(100vw - 4rem)"
        loading="lazy"
        width="973"
        height="973"
...
<modal-opener class="product__modal-opener product__modal-opener--image no-js-hidden" data-modal="#ProductModal-template--14270126424127__main">
  ...
  <button class="product__media-toggle" type="button" aria-haspopup="dialog" data-media-id="5824634060863">
    <span class="visually-hidden">
      Open media 2 in gallery view
				...
				<li id="Slide-template--14270126424127__main-5824637763647" class="protopimg-item product__media-item grid__item slider__slide" data-media-id="template--14270126424127__main-5824637763647">

<noscript><div class="product__media media" style="padding-top: 100.0%;">
      <img
        srcset="https://cdn.shopify.com/s/files/1/0257/0492/3199/products/21_9bca41a7-53f5-4760-8a4a-50c3d1be3fc3_493x.jpg?v=1575011477 493w,
          https://cdn.shopify.com/s/files/1/0257/0492/3199/products/21_9bca41a7-53f5-4760-8a4a-50c3d1be3fc3_600x.jpg?v=1575011477 600w,
          https://cdn.shopify.com/s/files/1/0257/0492/3199/products/21_9bca41a7-53f5-4760-8a4a-50c3d1be3fc3_713x.jpg?v=1575011477 713w,
          https://cdn.shopify.com/s/files/1/0257/0492/3199/products/21_9bca41a7-53f5-4760-8a4a-50c3d1be3fc3_823x.jpg?v=1575011477 823w,
          https://cdn.shopify.com/s/files/1/0257/0492/3199/products/21_9bca41a7-53f5-4760-8a4a-50c3d1be3fc3_992x.jpg?v=1575011477 992w,
          ...
          https://cdn.shopify.com/s/files/1/0257/0492/3199/products/21_9bca41a7-53f5-4760-8a4a-50c3d1be3fc3.jpg?v=1575011477 1000w"
        src="https://cdn.shopify.com/s/files/1/0257/0492/3199/products/21_9bca41a7-53f5-4760-8a4a-50c3d1be3fc3_1946x.jpg?v=1575011477"
        sizes="(min-width: 1600px) 825px, (min-width: 992px) calc(55.0vw - 10rem), (min-width: 768px) calc((100vw - 11.5rem) / 2), calc(100vw - 4rem)"
        loading="lazy"
        width="973"
        height="973"
...
<modal-opener class="product__modal-opener product__modal-opener--image no-js-hidden" data-modal="#ProductModal-template--14270126424127__main">
  ...
  <button class="product__media-toggle" type="button" aria-haspopup="dialog" data-media-id="5824637763647">
    <span class="visually-hidden">
      Open media 3 in gallery view
    </span>
  </button>
</modal-opener>
                </li><li id="Slide-template--14270126424127__main-5824637796415" class="protopimg-item product__media-item grid__item slider__slide" data-media-id="template--14270126424127__main-5824637796415">

<noscript><div class="product__media media" style="padding-top: 100.0%;">
      <img
        srcset="https://cdn.shopify.com/s/files/1/0257/0492/3199/products/22_257c0fe4-6969-4091-a1bd-4cb21a30038d_493x.jpg?v=1575011477 493w,
          https://cdn.shopify.com/s/files/1/0257/0492/3199/products/22_257c0fe4-6969-4091-a1bd-4cb21a30038d_600x.jpg?v=1575011477 600w,
          https://cdn.shopify.com/s/files/1/0257/0492/3199/products/22_257c0fe4-6969-4091-a1bd-4cb21a30038d_713x.jpg?v=1575011477 713w,
          https://cdn.shopify.com/s/files/1/0257/0492/3199/products/22_257c0fe4-6969-4091-a1bd-4cb21a30038d_823x.jpg?v=1575011477 823w,
          https://cdn.shopify.com/s/files/1/0257/0492/3199/products/22_257c0fe4-6969-4091-a1bd-4cb21a30038d_992x.jpg?v=1575011477 992w,
          ...
          https://cdn.shopify.com/s/files/1/0257/0492/3199/products/22_257c0fe4-6969-4091-a1bd-4cb21a30038d.jpg?v=1575011477 1000w"
        src="https://cdn.shopify.com/s/files/1/0257/0492/3199/products/22_257c0fe4-6969-4091-a1bd-4cb21a30038d_1946x.jpg?v=1575011477"
        sizes="(min-width: 1600px) 825px, (min-width: 992px) calc(55.0vw - 10rem), (min-width: 768px) calc((100vw - 11.5rem) / 2), calc(100vw - 4rem)"
        loading="lazy"
        width="973"
        height="973"
...
<modal-opener class="product__modal-opener product__modal-opener--image no-js-hidden" data-modal="#ProductModal-template--14270126424127__main">
  ...
  <button class="product__media-toggle" type="button" aria-haspopup="dialog" data-media-id="5824637796415">
    <span class="visually-hidden">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.354.646a.5.5 0 00-.708 0L5 4.293 1.354.646a.5.5 0 00-.708.708l4 4a.5.5 0 00.708 0l4-4a.5.5 0 000-.708z" fill="currentColor">
        ...
        </slider-component><slider-component id="GalleryThumbnails-template--14270126424127__main" class="thumbnail-slider slider-mobile-gutter">
            <button type="button" class="slider-button slider-button--prev medium-hide large-up-hide" name="previous" aria-label="Slide left" aria-controls="GalleryThumbnails-template--14270126424127__main" data-step="3"><svg aria-hidden="true" focusable="false" role="presentation" class="icon icon-caret" viewBox="0 0 10 6">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.354.646a.5.5 0 00-.708 0L5 4.293 1.354.646a.5.5 0 00-.708.708l4 4a.5.5 0 00.708 0l4-4a.5.5 0 000-.708z" fill="currentColor">
</svg>
</button>
            <ul id="Slider-Thumbnails-template--14270126424127__main" class="thumbnail-list list-unstyled slider slider--mobile slider--tablet-up">
			
			<?php 
	$multi_images="SELECT * FROM `multiple_images` where  product_id='".$id2."' ";
	$get_multi=mysqli_query($conn,$multi_images);
 	while($row_multi=mysqli_fetch_array($get_multi)){
	$image_id= $row_multi["image_id"];
	$image_name= $row_multi["image_name"];
	
	
	?>
			
			
			<li id="Slide-Thumbnails-template--14270126424127__main-0" class="thumbnail-list__item slider__slide" data-target="template--14270126424127__main-5824634093631" data-media-position="1">
                  ...
                  >
                    ...
                    <img id="Thumbnail-template--14270126424127__main-0" srcset="./admin/<?php echo 'admin_pics'; ?>/<?php echo $image_name; ?>"
                      src="./admin/<?php echo 'admin_pics'; ?>/<?php echo $image_name; ?>"
            ...
            <button type="button" class="slider-button slider-button--next medium-hide large-up-hide" name="next" aria-label="Slide right" aria-controls="GalleryThumbnails-template--14270126424127__main" data-step="3"><svg aria-hidden="true" focusable="false" role="presentation" class="icon icon-caret" viewBox="0 0 10 6">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.354.646a.5.5 0 00-.708 0L5 4.293 1.354.646a.5.5 0 00-.708.708l4 4a.5.5 0 00.708 0l4-4a.5.5 0 000-.708z" fill="currentColor">
</svg>
</button>
    ...
    <div class="product__info-wrapper grid__item">
      <div id="ProductInfo-template--14270126424127__main" class="product__info-container product__info-container--sticky"><p class="product__text" >webi</p><h1 class="product__title" ><?php echo $product_title ?></h1><div id="shopify-block-e48ec499-b216-4d52-822c-ebac8cc87c75" class="shopify-block shopify-app-block" data-block-handle="star_rating">
...
<div style="justify-content: center;" class="spr-starrating spr-summary-starrating" data-product-id="4397844955199">
  <!-- BEGIN app snippet: star_rating -->

<div class="spr-stars">
  <span role="img" aria-label="3.6 out of 5 stars">
        ...
        <svg aria-hidden="true" focusable="false" role="presentation" class="spr-star" style="width: 15px; height: 15px;" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
          <path fill="#ffcc00" d="M512,197.816L325.961 185.585 255.898 9.569 185.835 185.585 0 197.816 142.534 318.842 95.762 502.431 255.898 401.21 416.035 502.431 369.263 318.842z"></path>
        </svg>
        ...
        <svg aria-hidden="true" focusable="false" role="presentation" class="spr-star" style="width: 15px; height: 15px; enable-background:new 0 0 510 510;" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 510 510" xml:space="preserve">
          <path fill="#ffcc00" d="M510,197.472l-183.37-15.734L255,12.75l-71.629,168.988L0,197.472l0,0l0,0l139.103,120.539L97.41,497.25L255,402.186l0,0l157.59,95.039l-41.692-179.239L510,197.472z M255,354.348V117.172l43.605,102.918l111.689,9.588l-84.711,73.389l25.398,109.166L255,354.348z"/>
        </svg>
        ...
        <svg aria-hidden="true" focusable="false" role="presentation" class="spr-star" style="width: 15px; height: 15px;" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
          <path fill="#ffcc00 "d="M512,197.819l-185.933-12.228L256,9.571l-70.067,176.021L0,197.82l142.658,120.93L95.856,502.429L256,401.214 l160.144,101.215l-46.8-183.671L512,197.819z M256,365.724l-112.464,71.08l32.827-128.831L75.829,222.888l130.971-8.603 L256,90.687l49.2,123.599l131.124,8.602l-100.689,85.077l32.829,128.839L256,365.724z" />
        </svg>
...
<!-- END app snippet -->
    ...
    (<a href="#" class="link underlined-link" onClick="var el=document.querySelector('#shopify-product-reviews[data-id=\'4397844955199\']');el&&el.scrollIntoView();return false;">5<span class="visually-hidden"> total reviews</span></a>)
  
</div>


</div>
<div class="no-js-hidden mainp-price" id="price-template--14270126424127__main" role="status" >
<div class="price price--large price--show-badge">
  <div class="price__container"><div class="price__regular">
      <span class="visually-hidden visually-hidden--inline">Regular price</span>
      <span class="price-item price-item--regular">
        ? <?php echo $sale_price ?>.00
      </span>
    </div>
    <div class="price__sale">
      <span class="visually-hidden visually-hidden--inline">Sale price</span>
...
</div><div ><form method="post" action="/cart/add" id="product-form-installment" accept-charset="UTF-8" class="installment caption-large" enctype="multipart/form-data"><input type="hidden" name="form_type" value="product" /><input type="hidden" name="utf8" value="?" /><input type="hidden" name="id" value="31374865629247">
                    
</form></div><div class="product__description rte">
                    <p><?php echo $discription ?></p>
                </div><variant-radios class="no-js-hidden" data-section="template--14270126424127__main" data-url="/products/bl-go-plus-bluetooth-speaker" ><fieldset class="js product-form__input">
                                <legend class="form__label">Color</legend><input type="radio" id="template--14270126424127__main-1-0"
                                    name="Color"
                                    value="Blue"
                                    aria-label="Options"
                                    form="product-form-template--14270126424127__main"
                                    checked >
                                    <label class=" wbprodvarcolor" for="template--14270126424127__main-1-0" style="background-color: Blue;">
                                        </label><input type="radio" id="template--14270126424127__main-1-1"
                                    name="Color"
                                    value="Gray"
                                    aria-label="Options"
                                    form="product-form-template--14270126424127__main"
                                     >
                                    <label class=" wbprodvarcolor" for="template--14270126424127__main-1-1" style="background-color: Gray;">
                                        </label></fieldset><script type="application/json">
                            [{"id":31374865629247,"title":"Blue","option1":"Blue","option2":null,"option3":null,"sku":"","requires_shipping":true,"taxable":true,"featured_image":{"id":13658466058303,"product_id":4397844955199,"position":2,"created_at":"2019-11-29T02:11:00-05:00","updated_at":"2019-11-29T02:11:17-05:00","alt":null,"width":1000,"height":1000,"src":"https:\/\/cdn.shopify.com\/s\/files\/1\/0257\/0492\/3199\/products\/38.jpg?v=1575011477","variant_ids":[31374865629247]},"available":true,"name":"BL Go PLUS Bluetooth Speaker - Blue","public_title":"Blue","options":["Blue"],"price":10000,"weight":0,"compare_at_price":null,"inventory_management":"shopify","barcode":"","featured_media":{"alt":null,"id":5824634093631,"position":2,"preview_image":{"aspect_ratio":1.0,"height":1000,"width":1000,"src":"https:\/\/cdn.shopify.com\/s\/files\/1\/0257\/0492\/3199\/products\/38.jpg?v=1575011477"}},"quantity_rule":{"min":1,"max":null,"increment":1}},{"id":31374865662015,"title":"Gray","option1":"Gray","option2":null,"option3":null,"sku":"","requires_shipping":true,"taxable":true,"featured_image":{"id":13658466025535,"product_id":4397844955199,"position":1,"created_at":"2019-11-29T02:11:00-05:00","updated_at":"2019-11-29T02:11:17-05:00","alt":null,"width":1000,"height":1000,"src":"https:\/\/cdn.shopify.com\/s\/files\/1\/0257\/0492\/3199\/products\/37.jpg?v=1575011477","variant_ids":[31374865662015]},"available":true,"name":"BL Go PLUS Bluetooth Speaker - Gray","public_title":"Gray","options":["Gray"],"price":10000,"weight":0,"compare_at_price":null,"inventory_management":"shopify","barcode":"","featured_media":{"alt":null,"id":5824634060863,"position":1,"preview_image":{"aspect_ratio":1.0,"height":1000,"width":1000,"src":"https:\/\/cdn.shopify.com\/s\/files\/1\/0257\/0492\/3199\/products\/37.jpg?v=1575011477"}},"quantity_rule":{"min":1,"max":null,"increment":1}}]
                        </script>
                    </variant-radios><noscript class="product-form__noscript-wrapper-template--14270126424127__main">
                <div class="product-form__input">
                    <label class="form__label" for="Variants-template--14270126424127__main">Product variants</label>
                    <div class="select">
                        <select name="id" id="Variants-template--14270126424127__main" class="select__select" form="product-form-template--14270126424127__main"><option
                                selected="selected"
...
<div class="wbstockcount ">
                <div class="wbstockinfo wbstockinfo_high">In stock (30 units), ready to be shipped</div>
              ...
              }</style><link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-stock-countdown.css?v=124020204486494082011664955046" rel="stylesheet" type="text/css" media="all" />
              <script id="product-variants" type="application/json">
                {"31374865629247": 30,"31374865662015": 10}
              </script>
              <script id="product-stock-countdown-config" type="application/json">
                ...
                <label class="form__label" for="Quantity-template--14270126424127__main">
                    Quantity
                </label>
                <quantity-input class="quantity">
                    <button class="quantity__button no-js-hidden" name="minus" type="button">
                        <span class="visually-hidden">Decrease quantity for BL Go PLUS Bluetooth Speaker</span>
                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" role="presentation" class="icon icon-minus" fill="none" viewBox="0 0 10 2">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M.5 1C.5.7.7.5 1 .5h8a.5.5 0 110 1H1A.5.5 0 01.5 1z" fill="currentColor">
</svg><form method="post" action="singleproduct.php" id="product-form-template--14270126424127__main" accept-charset="UTF-8" class="form" enctype="multipart/form-data" novalidate="novalidate" data-type="add-to-cart-form">
         <?php 
	$show_quantity="SELECT * FROM `add_cart` where  product_id='".$id2."' and user_id='".$_SESSION['login_username_id']."'";
	$get_quantity=mysqli_query($conn,$show_quantity);
 	while($row123=mysqli_fetch_array($get_quantity)){
	$quantity_single= $row123["quantity"];
	}
	?>
                    </button>
                    ...
                    type="number"
                    name="quantity"
                    id="Quantity-template--14270126424127__main"
                    min="1"
                    value="<?php echo $quantity_single; ?>"
                    aria-label="<?php echo $quantity_single; ?>"
                    form="product-form-template--14270126424127__main" >
                    <button class="quantity__button no-js-hidden" name="plus" type="button">
                        <span class="visually-hidden">Increase quantity for BL Go PLUS Bluetooth Speaker</span>
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M1 4.51a.5.5 0 000 1h3.5l.01 3.5a.5.5 0 001-.01V5.5l3.5-.01a.5.5 0 00-.01-1H5.5L5.49.99a.5.5 0 00-1 .01v3.5l-3.5.01H1z" fill="currentColor">
                ...
                <product-form class="product-form">
					...
					<input type="hidden" name="single_pro_id" value="<?php echo $_REQUEST['product_view']; ?>">
                ...
                <link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-pickup-availability.css?v=114350900229557684741645685326" rel="stylesheet" type="text/css" media="all" />
<pickup-availability class="product__pickup-availabilities no-js-hidden"
                    
                    data-root-url="/"
                    data-variant-id="31374865629247"
  ...
  <path fill="#DE3618" stroke="#fff" d="M13.94 3.94L10 7.878l-3.94-3.94A1.499 1.499 0 103.94 6.06L7.88 10l-3.94 3.94a1.499 1.499 0 102.12 2.12L10 12.12l3.94 3.94a1.497 1.497 0 002.12 0 1.499 1.499 0 000-2.12L12.122 10l3.94-3.94a1.499 1.499 0 10-2.121-2.12z"/>
            ...
            <script src="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/pickup-availability.js?v=95345216988985239631645685343" defer="defer"></script><share-button id="Share-template--14270126424127__main" class="share-button" >
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M6.5 1.125C6.77614 1.125 7 1.34886 7 1.625V8.125C7 8.40114 6.77614 8.625 6.5 8.625C6.22386 8.625 6 8.40114 6 8.125V1.625C6 1.34886 6.22386 1.125 6.5 1.125Z" fill="currentColor"/>
                ...
                <details id="Details-share-template--14270126424127__main">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M6.5 1.125C6.77614 1.125 7 1.34886 7 1.625V8.125C7 8.40114 6.77614 8.625 6.5 8.625C6.22386 8.625 6 8.40114 6 8.125V1.625C6 1.34886 6.22386 1.125 6.5 1.125Z" fill="currentColor"/>
                    ...
                    <div id="Product-share-template--14270126424127__main" class="share-button__fallback motion-reduce">
                        <div class="field">
                            <span id="ShareMessage-template--14270126424127__main" class="share-button__message hidden" role="status"></span>
                            <input type="text"
                            class="field__input"
                            id="url"
                            value="https://storego-demo.myshopify.com/products/bl-go-plus-bluetooth-speaker"
                            placeholder="Link"
                            onclick="this.select();"
                            readonly >
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M2 1a1 1 0 011-1h7a1 1 0 011 1v9a1 1 0 01-1 1V1H2zM1 2a1 1 0 00-1 1v9a1 1 0 001 1h7a1 1 0 001-1V3a1 1 0 00-1-1H1zm0 10V3h7v9H1z" fill="currentColor"/>
            ...
            <script src="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/share.js?v=23059556731731026671645685351" defer="defer"></script><div class="product__accordion accordion" >
                <details id="Details-435ff1f5-92e8-432f-b433-d531976e5700-template--14270126424127__main">
                    <summary>
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M9.354.646a.5.5 0 00-.708 0L5 4.293 1.354.646a.5.5 0 00-.708.708l4 4a.5.5 0 00.708 0l4-4a.5.5 0 000-.708z" fill="currentColor">
                    ...
                    <div class="accordion__content rte" id="ProductAccordion-435ff1f5-92e8-432f-b433-d531976e5700-template--14270126424127__main">
                        
                        <p>Maecenas ut mi sed mi porta iaculis. Nulla a arcu metus. Nunc auctor nulla eget lacus fermentum pharetra. Donec nisi lacus, rhoncus vel fringilla sit amet, porttitor sit amet velit. Nam eu diam et nibh feugiat volutpat. Phasellus nec commodo leo, vitae scelerisque libero. Sed sed diam nibh. Nullam accumsan mollis vulputate. Duis aliquam imperdiet est. Morbi sit amet tristique tellus. Maecenas vehicula posuere metus eget semper. Etiam ut felis erat.</p>
<p>Nullam consequat tempus fringilla. In facilisis elit a nibh fermentum cursus. Nulla facilisis id libero quis egestas. Nunc vitae malesuada nunc. Quisque maximus libero vitae orci bibendum, sed dapibus risus ornare. Quisque rutrum cursus justo in bibendum. Curabitur vitae risus maximus, varius tellus eu, scelerisque enim. Curabitur et accumsan lorem. Aenean sit amet facilisis arcu. Pellentesque non magna fringilla, vehicula velit eu, consequat magna. Vestibulum orci diam, malesuada non libero non, faucibus laoreet dui.</p>
<p>Fusce luctus quam a nibh mollis aliquam. Etiam orci nisl, porta non eros quis, interdum varius augue. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Donec pellentesque, odio dictum tempor dictum, ligula nibh finibus nisi, sit amet sollicitudin felis arcu vitae velit. Aliquam mollis purus in orci consequat maximus. Quisque vitae nisl a urna porttitor viverra ac maximus quam. Ut vel ullamcorper sapien. Phasellus volutpat justo nisl, id vehicula tortor varius sed. Aenean pulvinar velit at nunc bibendum, ut cursus eros blandit. Ut condimentum, metus vel suscipit vestibulum, quam diam ultrices est, tincidunt luctus tellus mi a sem. Nullam lobortis finibus sem vitae pretium. Vestibulum eu auctor sapien, sed malesuada tortor.</p>
<p>Maecenas nulla ipsum, posuere eu ante non, blandit aliquet orci. Curabitur et purus at elit condimentum consectetur ac nec augue. Duis tincidunt porta purus, at dignissim erat ultricies eget. Praesent eros nisl, accumsan eleifend nisi in, ultrices pharetra sem. Phasellus convallis scelerisque euismod. Proin ac ligula in elit vestibulum gravida. Praesent vitae dolor tincidunt, vehicula erat vitae, varius augue. Morbi ultrices diam lacus, quis lobortis dui faucibus sit amet. Integer pellentesque ex eget semper efficitur. Praesent sit amet tristique diam. Nulla convallis eros libero, non pellentesque erat dapibus in. Aliquam sagittis nec ligula vel efficitur.</p>
<p>Nunc sit amet ligula eu nulla aliquam varius sit amet ac tellus. Donec suscipit, risus vel cursus faucibus, nibh urna tincidunt mi, et egestas quam magna id ligula. Donec non mauris nisi. Aliquam vehicula massa a dolor faucibus, suscipit facilisis ligula rutrum. Vestibulum dignissim lacus eget ipsum volutpat, id porttitor ipsum elementum. Fusce finibus lacus non ante sollicitudin, non accumsan metus venenatis. Fusce at libero ut libero tincidunt scelerisque. Suspendisse faucibus turpis sed erat varius, ut finibus enim accumsan. Etiam pretium fringilla aliquam. Quisque non tortor a ipsum fermentum iaculis. Aliquam a tincidunt mi. Etiam fermentum purus sit amet eros finibus aliquam. Nunc bibendum iaculis molestie. Suspendisse dignissim metus ante, nec varius mi consequat ac. Vivamus quam sem, laoreet quis fermentum quis, gravida quis mauris.</p>
<p>Etiam non maximus nisi, vitae tempus nunc. Duis tristique, justo et rutrum pretium, tellus orci convallis urna, nec lacinia elit est non tellus. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nam laoreet ex ipsum, vitae pulvinar nibh ullamcorper sit amet. Fusce quis libero eget urna finibus tincidunt. Integer ac consectetur lacus, a vulputate purus. Vestibulum dictum semper nulla a placerat. In pellentesque vehicula leo, eget convallis odio rhoncus sit amet. Suspendisse volutpat risus sit amet aliquet porta. Quisque in faucibus sapien. Duis dolor tortor, efficitur ac massa a, fermentum auctor metus. Proin ullamcorper eget odio a viverra.</p>
                    </div>
                </details>
            </div><ul class="social-sharing">
                
                    <li>
                        <a target="_blank" href="//www.facebook.com/sharer.php?u=https://storego-demo.myshopify.com" class="share-facebook">
  ...
  <path fill="currentColor" d="M16.42.61c.27 0 .5.1.69.28.19.2.28.42.28.7v15.44c0 .27-.1.5-.28.69a.94.94 0 01-.7.28h-4.39v-6.7h2.25l.31-2.65h-2.56v-1.7c0-.4.1-.72.28-.93.18-.2.5-.32 1-.32h1.37V3.35c-.6-.06-1.27-.1-2.01-.1-1.01 0-1.83.3-2.45.9-.62.6-.93 1.44-.93 2.53v1.97H7.04v2.65h2.24V18H.98c-.28 0-.5-.1-.7-.28a.94.94 0 01-.28-.7V1.59c0-.27.1-.5.28-.69a.94.94 0 01.7-.28h15.44z">
                    ...
                    <li>
                        <a target="_blank" href="//twitter.com/share?text=&amp;url=https://storego-demo.myshopify.com" class="share-twitter">
  ...
  <path fill="currentColor" d="M17.64 2.6a7.33 7.33 0 01-1.75 1.82c0 .05 0 .13.02.23l.02.23a9.97 9.97 0 01-1.69 5.54c-.57.85-1.24 1.62-2.02 2.28a9.09 9.09 0 01-2.82 1.6 10.23 10.23 0 01-8.9-.98c.34.02.61.04.83.04 1.64 0 3.1-.5 4.38-1.5a3.6 3.6 0 01-3.3-2.45A2.91 2.91 0 004 9.35a3.47 3.47 0 01-2.02-1.21 3.37 3.37 0 01-.8-2.22v-.03c.46.24.98.37 1.58.4a3.45 3.45 0 01-1.54-2.9c0-.61.14-1.2.45-1.79a9.68 9.68 0 003.2 2.6 10 10 0 004.08 1.07 3 3 0 01-.13-.8c0-.97.34-1.8 1.03-2.48A3.45 3.45 0 0112.4.96a3.49 3.49 0 012.54 1.1c.8-.15 1.54-.44 2.23-.85a3.4 3.4 0 01-1.54 1.94c.74-.1 1.4-.28 2.01-.54z">
                    ...
                    <li>
                        <a target="_blank" href="//pinterest.com/pin/create/button/?url=https://storego-demo.myshopify.com&amp;media=https://cdn.shopify.com/shopifycloud/shopify/assets/no-image-2048-5e88c1b20e087fb7bbe9a3771824e743c244f437e4f8ba93bbf7b11b53f7824c_1024x1024.gif&amp;description=" class="share-pinterest">
  ...
  <div class="spr-form1111" id="form_4397844955199111" style="">
  <form method="post" action="singleproduct.php">
  <input type="hidden" name="product_id_top" value="<?php echo $_REQUEST['product_view'] ?>">
  <input type="hidden" name="product_id" value="4397844955199">
  <h3 class="spr-form-title">Write a review</h3>


    <fieldset class="spr-form-review">
<input type="hidden" name="rating_star" value="" class="value_rating"/>
      <div class="spr-form-review-rating">
        <label class="spr-form-label" for="review[rating]">Rating</label>
        <div class="spr-form-input spr-starrating ">
          <a href="" onClick="SPR.setRating(this);return false;" id="value_rating_id" class="spr-icon spr-icon-star spr-icon-star-empty" data-value="1" aria-label="1 of 5 stars">&nbsp;</a>
          <a href="" onClick="SPR.setRating(this);return false;" id="value_rating_id2" class="spr-icon spr-icon-star spr-icon-star-empty" data-value="2" aria-label="2 of 5 stars">&nbsp;</a>
          <a href="" onClick="SPR.setRating(this);return false;" id="value_rating_id3" class="spr-icon spr-icon-star spr-icon-star-empty" data-value="3" aria-label="3 of 5 stars">&nbsp;</a>
          <a href="" onClick="SPR.setRating(this);return false;" id="value_rating_id4" class="spr-icon spr-icon-star spr-icon-star-empty" data-value="4" aria-label="4 of 5 stars">&nbsp;</a>
          <a href="" onClick="SPR.setRating(this);return false;" id="value_rating_id5" class="spr-icon spr-icon-star spr-icon-star-empty" data-value="5" aria-label="5 of 5 stars">&nbsp;</a>
        </div>
      </div>
  ...
  $("#value_rating_id").click(function() {
  
    var inputValue = $("#value_rating_id").attr("data-value");
	    $(".value_rating").val(inputValue);
  });	
  $("#value_rating_id2").click(function() {
  
    var inputValue2 = $("#value_rating_id2").attr("data-value");
	    $(".value_rating").val(inputValue2);
  });	
  $("#value_rating_id3").click(function() {
  
    var inputValue3 = $("#value_rating_id3").attr("data-value");
	    $(".value_rating").val(inputValue3);
  });	      
  $("#value_rating_id4").click(function() {
  
    var inputValue4 = $("#value_rating_id4").attr("data-value");
	    $(".value_rating").val(inputValue4);
  });	
   $("#value_rating_id5").click(function() {
  
    var inputValue5 = $("#value_rating_id5").attr("data-value");
	    $(".value_rating").val(inputValue5);
  });	 
	  });
	  	  
	  </script>
      <div class="spr-form-review-body">
        <label class="spr-form-label" for="review_body_4397844955199">
          Body of Review
        ...
        <div class="spr-form-input">
          <textarea class="spr-form-input spr-form-input-textarea " id="review_body_4397844955199" data-product-id="4397844955199" name="comments" rows="10" placeholder="Write your comments here"></textarea>
          <script>
            function sprUpdateCount(e){
              var $el = SPR.$(e.currentTarget);
              SPR.$(".spr-form-review-body-charactersremaining").html('(' + (1500 - $el.val().length) + ')');
            }
            SPR.$("textarea[data-product-id=4397844955199]").keyup(sprUpdateCount).trigger("keyup");
          </script>
        </div>
      </div>
    </fieldset>
    ...
    <fieldset class="spr-form-actions">
      <input type="submit" class="spr-button spr-button-primary button button-primary btn btn-primary" name="submit_review" value="Submit Review">
    </fieldset></form></div>
  
  <br/>
  <div style="width:600px;margin-left:auto;margin-right:auto;overflow:hidden;font-size:37px;text-align:center;">Reviews</div>
  <div style="width:600px;margin-left:auto;margin-right:auto;overflow:hidden;padding:10px;border:1px solid #CCCCCC;border-radius:20px;height:auto;">
  
 
    <?php
  
   $get_reviews="SELECT * FROM `product_reviews` where product_id='".$_REQUEST['product_view']."'";
   ...
   $get_name="SELECT * FROM `users_details` where user_id='".$user_id."'";
	$result1=mysqli_query($conn,$get_name);
  ...
  <div style="width:270px;float:left;overflow:hidden;border:1px solid #CCCCCC; padding:7px; border-radius:20px; margin-right:15px; margin-top:10px;"> 
    <style type="text/css">
...
<div class="Stars" style="--rating: <?php echo $rating; ?>;" aria-label="Rating of this product is 2.3 out of 5."> 
  ...
  <?php 
   ...
   ?>
    ...
    </div><product-modal id="ProductModal-template--14270126424127__main" class="product-media-modal media-modal">
    <div class="product-media-modal__dialog" role="dialog" aria-label="Media gallery" aria-modal="true" tabindex="-1">
      <button id="ModalClose-template--14270126424127__main" type="button" class="product-media-modal__toggle" aria-label="Close"><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" role="presentation" class="icon icon-close" fill="none" viewBox="0 0 18 17">
  <path d="M.865 15.978a.5.5 0 00.707.707l7.433-7.431 7.579 7.282a.501.501 0 00.846-.37.5.5 0 00-.153-.351L9.712 8.546l7.417-7.416a.5.5 0 10-.707-.708L8.991 7.853 1.413.573a.5.5 0 10-.693.72l7.563 7.268-7.418 7.417z" fill="currentColor">
</svg>
</button>
...
<img class="img-fluid mx-auto" 
    srcset="https://cdn.shopify.com/s/files/1/0257/0492/3199/products/38_550x.jpg?v=1575011477 550w,https://cdn.shopify.com/s/files/1/0257/0492/3199/products/38.jpg?v=1575011477 1000w"
    sizes="(min-width: 768px) calc(100vw - 22rem), 1100px"
    src="https://cdn.shopify.com/s/files/1/0257/0492/3199/products/38_1445x.jpg?v=1575011477"
    alt="BL Go PLUS Bluetooth Speaker"
    loading="lazy"
    width="1100"
    height="1100"
    data-media-id="5824634093631"
    
  >
<img class="img-fluid mx-auto" 
    srcset="https://cdn.shopify.com/s/files/1/0257/0492/3199/products/37_550x.jpg?v=1575011477 550w,https://cdn.shopify.com/s/files/1/0257/0492/3199/products/37.jpg?v=1575011477 1000w"
    sizes="(min-width: 768px) calc(100vw - 22rem), 1100px"
    src="https://cdn.shopify.com/s/files/1/0257/0492/3199/products/37_1445x.jpg?v=1575011477"
    alt="BL Go PLUS Bluetooth Speaker"
    loading="lazy"
    width="1100"
    height="1100"
    data-media-id="5824634060863"
    
  >
<img class="img-fluid mx-auto" 
    srcset="https://cdn.shopify.com/s/files/1/0257/0492/3199/products/21_9bca41a7-53f5-4760-8a4a-50c3d1be3fc3_550x.jpg?v=1575011477 550w,https://cdn.shopify.com/s/files/1/0257/0492/3199/products/21_9bca41a7-53f5-4760-8a4a-50c3d1be3fc3.jpg?v=1575011477 1000w"
    sizes="(min-width: 768px) calc(100vw - 22rem), 1100px"
    src="https://cdn.shopify.com/s/files/1/0257/0492/3199/products/21_9bca41a7-53f5-4760-8a4a-50c3d1be3fc3_1445x.jpg?v=1575011477"
    alt="BL Go PLUS Bluetooth Speaker"
    loading="lazy"
    width="1100"
    height="1100"
    data-media-id="5824637763647"
    
  >
<img class="img-fluid mx-auto" 
    srcset="https://cdn.shopify.com/s/files/1/0257/0492/3199/products/22_257c0fe4-6969-4091-a1bd-4cb21a30038d_550x.jpg?v=1575011477 550w,https://cdn.shopify.com/s/files/1/0257/0492/3199/products/22_257c0fe4-6969-4091-a1bd-4cb21a30038d.jpg?v=1575011477 1000w"
    sizes="(min-width: 768px) calc(100vw - 22rem), 1100px"
    src="https://cdn.shopify.com/s/files/1/0257/0492/3199/products/22_257c0fe4-6969-4091-a1bd-4cb21a30038d_1445x.jpg?v=1575011477"
    alt="BL Go PLUS Bluetooth Speaker"
    loading="lazy"
    width="1100"
    height="1100"
    data-media-id="5824637796415"
...
<section id="shopify-section-template--14270126424127__product-recommendations" class="shopify-section spaced-section"><link rel="stylesheet" href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/section-product-recommendations.css?v=43755720937753601011645685350" media="print" onload="this.media='all'">
<noscript><link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/section-product-recommendations.css?v=43755720937753601011645685350" rel="stylesheet" type="text/css" media="all" /></noscript>


<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-card.css?v=100729205794507640871679391631" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-price.css?v=75926142592083736931648449696" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-product-grid.css?v=139211915441709507551664166894" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-rating.css?v=149782489698461958261645685328" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-loading-overlay.css?v=28628663824550559871645685324" rel="stylesheet" type="text/css" media="all" />
...
<product-recommendations class="product-recommendations" data-url="/recommendations/products?section_id=template--14270126424127__product-recommendations&product_id=4397844955199&limit=4">
