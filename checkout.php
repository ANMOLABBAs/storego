...
if (!$_SESSION['login_username_id']) {

header("location:login.php");

}

if(isset($_REQUEST['Logout'])=='yes'){

$login_user="UPDATE `user_detail` SET `login_users` = '0' WHERE `user_detail`.`user_id` ='".$_SESSION['login_username_id']."'";
mysqli_query($conn,$login_user);
...
if (isset($_REQUEST['orderplace'])) {

$billing_country=$_REQUEST['country'];
$billing_first_name=$_REQUEST['firstname'];
$billing_last_name=$_REQUEST['lastname'];
$billing_company=$_REQUEST['company'];
$billing_address=$_REQUEST['address'];
$billing_postalcode=$_REQUEST['postalcode'];
...
$select_status="SELECT * FROM `status_order` where status_id='2' ";
$result_select_status=mysqli_query($conn,$select_status);
while ($row_select_status=mysqli_fetch_assoc($result_select_status)) {

$status=$row_select_status['status'];

}

$update_address="UPDATE `user_address` SET `firstname`='".$billing_first_name."',`lastname`='".$billing_last_name."',`company`='".$billing_company."',`address`='".$billing_address."',`city`='".$billing_city."',`country`='".$billing_country."',`postalcode`='".$billing_postalcode."',`phone`='".$billing_phone."',`user_id`='".$_SESSION['login_username_id']."' WHERE address_id='".$address_id."'";
mysqli_query($conn,$update_address);

$insert_order="INSERT INTO `order_details` (`order_id` ,`first_name` ,`last_name` ,`country_name` ,`company_name` ,`address` ,`city` ,`postal_code` ,`phone` ,`user_id` ,
`total_price` , `status` , `date`)VALUES (NULL , '".$billing_first_name."', '".$billing_last_name."', '".$billing_country."', '".$billing_company."', '".$billing_address."', '".$billing_city."', '".$billing_postalcode."', '".$billing_phone."', '".$_SESSION['login_username_id']."', '".$total_price."' , '".$status."' , '".$date."');";
$conn->query($insert_order);
$insert_order_id=mysqli_insert_id($conn);

$_SESSION['order_id']=$insert_order_id;


$get_data="SELECT * FROM `add_cart` where user_id='".$_SESSION['login_username_id']."'";
...
$insert_cart_order="INSERT INTO `cart_order` (`cart_id` ,`product_id` ,`user_id` ,`quantity` ,`order_id`)VALUES (NULL , '".$product_id."', '".$_SESSION['login_username_id']."','".$qty."', '".$insert_order_id."');";
$conn->query($insert_cart_order);


$delete_cart="DELETE FROM add_cart where user_id='".$_SESSION['login_username_id']."'";
$conn->query($delete_cart);

//header("location:checkout.php?paypal_form_submit=1");


header("location:thanks.php?order_id=$insert_order_id");
...
<html class="no-js wbboxlt" lang="en" >
  <head>
    ...
    <link rel="canonical" href="https://storego-demo.myshopify.com/account">
    <link rel="preconnect" href="https:https://cdn.shopify.com" crossorigin><link rel="icon" type="image/png" href="https://cdn.shopify.com/s/files/1/0257/0492/3199/files/Favicon_a8c7c7e1-5312-4697-a323-8607cbd976f4_32x32.png?v=1657006073"><title>STOREGO | My Account</title>
...
<meta property="og:url" content="https://storego-demo.myshopify.com/account">
<meta property="og:title" content="Account">
<meta property="og:type" content="website">
<meta property="og:description" content="Storego Shopify Description"><meta property="og:image" content="https://cdn.shopify.com/s/files/1/0257/0492/3199/files/offerbanner.jpg?v=1646043908">
...
<link rel="alternate" hreflang="x-default" href="https://storego-demo.myshopify.com/account">
<link rel="alternate" hreflang="en-IN" href="https://storego-demo.myshopify.com/account">
<link rel="alternate" hreflang="ar-IN" href="https://storego-demo.myshopify.com/ar/account">
<link rel="alternate" hreflang="en-US" href="https://storego-demo.myshopify.com/en-us/account">
<link rel="alternate" hreflang="ar-US" href="https://storego-demo.myshopify.com/ar-us/account">
<script>
  (function() {
...
<script id="__st">var __st={"a":25704923199,"offset":-14400,"reqid":"52378e61-1c97-4f21-a65d-722bc867fb4c","pageurl":"storego-demo.myshopify.com\/account","u":"c0c5106a3a25","cid":6404506648639};</script>
...
<script async="async" src="https://www.google-analytics.com/analytics.js"></script>
  ...
  <body class="gradient customer-logged-in template-customers-account">
...
<p class="announcement-bar__message" style="color: #ffffff;">
            ...
            <div class="col-md-6 text-right headtleft">
              <localization-form><form method="post" action="/localization" id="FooterCountryForm" accept-charset="UTF-8" class="localization-form" enctype="multipart/form-data"><input type="hidden" name="form_type" value="localization" /><input type="hidden" name="utf8" value="?" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="return_to" value="/account" /><div class="no-js-hidden">
...
<div class="customer account">
    <h1 class="heading text-left"><span>Checkout</span></h1>
	
	<?php 
	
	$select_address="SELECT * FROM `user_address` WHERE user_id='".$_SESSION['login_username_id']."' LIMIT 1";
	$result_address=mysqli_query($conn,$select_address);
	$rowcount_result_address=mysqli_num_rows($result_address);

	while($row_result_address=mysqli_fetch_assoc($result_address)){
	
	$address_id	= $row_result_address['address_id'];
	$firstname	= $row_result_address['firstname'];
	$lastname	= $row_result_address['lastname'];
	$company	= $row_result_address['company'];
	$address	= $row_result_address['address'];
	$city	    = $row_result_address['city'];
	$country	= $row_result_address['country'];
	$postalcode	= $row_result_address['postalcode'];
	$phone      = $row_result_address['phone'];
...
<form method="post" action="checkout.php" id="address_form_new" accept-charset="UTF-8" aria-labelledBy="AddressNewHeading" enctype="multipart/form-data">
		<input type="hidden" name="form_type" value="customer_address" />
		<input type="hidden" name="address_id" value="<?php echo $address_id; ?>" /><div class="field">
            <input type="text" id="AddressFirstNameNew" name="firstname" value="<?php echo $firstname; ?>" autocomplete="given-name" placeholder="First name">
            <label for="AddressFirstNameNew">First name</label>
          </div>
          <div class="field">
            <input type="text" id="AddressLastNameNew" name="lastname" value="<?php echo $lastname; ?>" autocomplete="family-name" placeholder="Last name">
            <label for="AddressLastNameNew">Last name</label>
          </div>
          <div class="field">
            <input type="text" id="AddressCompanyNew" name="company" value="<?php echo $company; ?>" autocomplete="organization" placeholder="Company">
            <label for="AddressCompanyNew">Company</label>
          </div>
          <div class="field">
            <input type="text" id="AddressAddress1New" name="address" value="<?php echo $address; ?>" autocomplete="address-line1" placeholder="Address 1">
            <label for="AddressAddress1New">Address 1</label>
          </div>
          <div class="field">
            <input type="text" id="AddressCityNew" name="city" value="<?php echo $city; ?>" autocomplete="address-level2" placeholder="City">
          ...
          <div>
            ...
            <div class="select">
              <select
                ...
                name="country"
                data-default="<?php echo $country; ?>"
                autocomplete="country"
              >
                <option value="<?php echo $country; ?>" data-provinces="[]"><?php echo $country; ?></option>
...
<option value="Zimbabwe" data-provinces="[]">Zimbabwe</option>
          ...
          <div class="field">
            <input type="text" id="AddressZipNew" name="postalcode" value="<?php echo $postalcode; ?>" autocapitalize="characters" autocomplete="postal-code" placeholder="Postal/ZIP code">
            <label for="AddressZipNew">Postal/ZIP code</label>
          </div>
          <div class="field">
            <input type="tel" id="AddressPhoneNew" name="phone" value="<?php echo $phone; ?>" autocomplete="tel" placeholder="Phone">
...
$get_cart_order_details12="SELECT * FROM `add_cart` where user_id='".$_SESSION['login_username_id']."'";
$result_cod12=mysqli_query($conn,$get_cart_order_details12);	
while ($row_result_cod12=mysqli_fetch_array($result_cod12)) {

$product_id_cod12=$row_result_cod12['product_id'];

	
	
	$get_users123412="SELECT * FROM `add_product` where product_id='".$product_id_cod12."'";
	$result123412=mysqli_query($conn,$get_users123412);
	$rowcount123412=mysqli_num_rows($result123412);	
	 
	 }
	 
	 ?>
	
	<?php if (isset($rowcount123412)>0) { ?>
	<div style="width:100%;overflow:hidden;border:1px solid #333333;">
		<div style="width:7%;float:left;font-size:23px;padding:8px;border:1px solid #333333;text-align:center;">Sr#</div>
		<div style="width:43%;float:left;font-size:23px;padding:8px;border:1px solid #333333;text-align:center;">Product Name</div>
		<div style="width:25%;float:left;font-size:23px;padding:8px;border:1px solid #333333;text-align:center;">Product Quantity</div>
		<div style="width:25%;float:left;font-size:23px;padding:8px;border:1px solid #333333;text-align:center;">Product Price</div>
	</div>
	<?php } ?>

<?php 

$get_cart_order_details="SELECT * FROM `add_cart` where user_id='".$_SESSION['login_username_id']."'";
$result_cod=mysqli_query($conn,$get_cart_order_details);

$sr=0;
$final_price_done=0;
$quantity=0;
	
while ($row_result_cod=mysqli_fetch_array($result_cod)) {

$sr=$sr+1;
$quantity+=intval($row_result_cod['quantity']);
$product_id_cod=$row_result_cod['product_id'];
$quantity_cod=$row_result_cod['quantity'];


	$get_users1234="SELECT * FROM `add_product` where product_id='".$product_id_cod."' ";
	$result1234=mysqli_query($conn,$get_users1234);
	$rowcount1234=mysqli_num_rows($result1234);
	
 	while($row=mysqli_fetch_assoc($result1234)){

	$product_title_main=$row['title'];
	$sale_price_main=intval($row['sale_price']*$quantity_cod);
	$final_price_done+= intval($row["sale_price"]*$quantity_cod);
 ...
 ?>
	...
	<div style="width:100%;overflow:hidden;border:1px solid #333333;margin-top:-1px;">
		<div style="width:7%;float:left;font-size:23px;padding:8px;border:1px solid #333333;text-align:center;"><?php echo $sr; ?></div>
		<div style="width:43%;float:left;font-size:23px;padding:8px;border:1px solid #333333;text-align:center;"><?php echo $product_title_main; ?></div>
		<div style="width:25%;float:left;font-size:23px;padding:8px;border:1px solid #333333;text-align:center;"><?php echo $quantity_cod; ?></div>
		<div style="width:25%;float:left;font-size:23px;padding:8px;border:1px solid #333333;text-align:center;">$<?php echo $sale_price_main; ?></div>
	</div>
...
<?php
 ...
 ?>	
  ...
  <?php if (!isset($rowcount1234)>0) { ?>

 <div  style="width:100%;text-align:center;overflow:hidden;font-size:33px;">EMPTY! No item added in cart</div>
 ...
 <?php } ?>
	...
	$get_users12341111="SELECT * FROM `add_cart` where user_id='".$_SESSION['login_username_id']."'";
	$result12341111=mysqli_query($conn,$get_users12341111);
	$rowcount12341111=mysqli_num_rows($result12341111);
	$sr=0;
	$final_price_done=0;
	$quantity=0;
 	while($row11=mysqli_fetch_assoc($result12341111)){		
	
	$product_qty=$row11["quantity"];
	$product_id_qty_11111= $row11["product_id"];
	$quantity+= $row11["quantity"];

	$get_users1234="SELECT * FROM `add_product` where product_id='".$product_id_qty_11111."' ";
	$result1234=mysqli_query($conn,$get_users1234);
	$rowcount1234=mysqli_num_rows($result1234);
	
 	while($row=mysqli_fetch_assoc($result1234)){
	$sr=$sr+1;
	$final_price_done+= $row["sale_price"]*$product_qty;
	}
	...
	<input type="hidden" name="total_price" value="<?php echo $final_price_done; ?>"/>
	
	<div style="width:400px;margin-left:auto;margin-right:auto;overflow:hidden;margin-top:9px;">
	<div style="width:100%;overflow:hidden;">
		<div style="width:50%;float:left;overflow:hidden;font-size:25px;">Quantity</div>
		<div style="width:50%;float:left;overflow:hidden;font-size:25px;">Total Price</div>
	</div>
	<div style="width:100%;overflow:hidden;">
		<div style="width:50%;float:left;overflow:hidden;font-size:25px;"><?php echo $quantity; ?></div>
		<div style="width:50%;float:left;overflow:hidden;font-size:25px;">$ <?php echo $final_price_done; ?></div>
	</div>	
	</div>
	
            <button type="submit" name="orderplace">Place Order</button>
...
<div class="footer__content-bottom text-center" style="background-color: #000000;">
	...
	<form method="post" id="paypal_form" name="cart" action="https://www.sandbox.paypal.com/cgi-bin/webscr">
  ...
  <input type="hidden" name="return" value="http://localhost/storego_project/thanks.php?order_id=<?php echo $insert_order_id; ?>">

<?php 

$get_cart_order_details12="SELECT * FROM `cart_order` where user_id='".$_SESSION['login_username_id']."' and order_id='".$_SESSION['order_id']."'";
$result_cod12=mysqli_query($conn,$get_cart_order_details12);
$sr12=0;
while ($row_result_cod12=mysqli_fetch_array($result_cod12)) {
$product_id_cod12=$row_result_cod12['product_id'];
$quantity_cod12=$row_result_cod12['quantity'];
	$get_users123412="SELECT * FROM `add_product` where product_id='".$product_id_cod12."' ";
	$result123412=mysqli_query($conn,$get_users123412);
	$rowcount123412=mysqli_num_rows($result123412);
 	while($row12=mysqli_fetch_assoc($result123412)){
$sr12=$sr12+1;
	$product_title_main12=$row12['title'];
	$product_sale_price_paypal12=$row12['sale_price']; 
	}
	
	?>
    <input type="hidden" name="item_name_<?php echo $sr12; ?>" value="<?php echo $product_title_main12; ?>"/>
  <input type="hidden" name="amount_<?php echo $sr12; ?>" value="<?php echo $product_sale_price_paypal12; ?>"/>
  <input type="hidden" name="quantity_<?php echo $sr12; ?>" value="<?php echo $quantity_cod12; ?>"> 
  


<?php } ?>
 
   <input type="image" src="https://www.paypal.com/en_US/i/btn/btn_buynowCC_LG.gif" id="btn_paypal_confirm" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
  <img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">
</form>
	
	
<?php if (isset($_REQUEST['paypal_form_submit'])=='1') { ?>
...
$( "#btn_paypal_confirm" ).trigger( "click" );
