...
$conn->query($login_user);
  ...
  $_SESSION['login_username_id']="";
    ...
    header("Location: login.php");
	  ...
	  if (isset($_REQUEST['cart_updated'])) {
	  
$quantity_tb_updated=$_REQUEST['qty'];
	  $pro_id=$_REQUEST['pro_id'];
	 
	 //print_r($quantity_tb_updated); 
$count_cart=count($quantity_tb_updated);


for ($cartloop=0; $cartloop<$count_cart; $cartloop++){

$insert_into_cart11="UPDATE `add_cart` SET `quantity`='".$quantity_tb_updated[$cartloop]."' WHERE product_id='".$pro_id[$cartloop]."' and user_id='".$_SESSION['login_username_id']."'";
mysqli_query($conn,$insert_into_cart11);

}


header("location:cart.php?updated_cart");
...
$del_single="DELETE FROM `add_cart` WHERE `product_id`='".$delete_product_id."' ";
mysqli_query($conn,$del_single);
...
$select_address="SELECT * FROM `user_address` where user_id='".$_SESSION['login_username_id']."'";
$result_address=mysqli_query($conn,$select_address);
$rowcount_address=mysqli_num_rows($result_address);

if ($rowcount_address>0) {
...
<html class="no-js wbboxlt" lang="en" >
  <head>
    ...
    <link rel="canonical" href="https://storego-demo.myshopify.com/cart">
...
<meta property="og:url" content="https://storego-demo.myshopify.com/cart">
...
<link rel="alternate" hreflang="x-default" href="https://storego-demo.myshopify.com/cart">
<link rel="alternate" hreflang="en-IN" href="https://storego-demo.myshopify.com/cart">
<link rel="alternate" hreflang="ar-IN" href="https://storego-demo.myshopify.com/ar/cart">
<link rel="alternate" hreflang="en-US" href="https://storego-demo.myshopify.com/en-us/cart">
<link rel="alternate" hreflang="ar-US" href="https://storego-demo.myshopify.com/ar-us/cart">
<script>
  (function() {
...
<script id="__st">var __st={"a":25704923199,"offset":-14400,"reqid":"39ee69ab-1ecd-4536-b08b-0a1ef9251d45","pageurl":"storego-demo.myshopify.com\/cart","t":"prospect","u":"509626a295ff","cid":6404506648639};</script>
...
<script id="sections-script" data-sections="main-cart-footer,header" defer="defer" src="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/compiled_assets/scripts.js?10371"></script>
...
<script async="async" src="https://www.google-analytics.com/analytics.js"></script>
  ...
  <body class="gradient customer-logged-in template-cart">
	...
	<nav class="breadcrumb row" role="navigation" aria-label="breadcrumbs">
		<div class="col-12">
			<a href="index.php" title="Home">Home</a>
                ...
                <div id="shopify-section-template--14270126129215__cart-items" class="shopify-section"><link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-cart.css?v=120599242479404763711645685321" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-totals.css?v=93346863290357109701645685330" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-price.css?v=75926142592083736931648449696" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-discounts.css?v=13156439235383754671645685322" rel="stylesheet" type="text/css" media="all" />
...
<script src="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/cart.js?v=10017497365385121541645685318" defer="defer"></script>

<cart-items class="">
  <div class="carthead">
    <h1 class="heading text-left">Your cart</h1>
    <a href="products.php" class="underlined-link">Continue shopping</a>
  </div>
  ...
  <form action="cart.php" method="post" id="cart">
    <div id="main-cart-items" data-id="template--14270126129215__cart-items">
...
$get_users_cart="SELECT * FROM `add_cart` where user_id='".$_SESSION['login_username_id']."'";
	$result_cart=mysqli_query($conn,$get_users_cart);
	$rowcount_cart=mysqli_num_rows($result_cart);
 	while($row_cart=mysqli_fetch_assoc($result_cart)){	
	$product_id_qty_cart= $row_cart["product_id"];
	$quantity_id_qty_cart= intval($row_cart["quantity"]);
    
	
	
	
	$get_users_product="SELECT * FROM `add_product` where product_id='".$product_id_qty_cart."' ";
	$result_product=mysqli_query($conn,$get_users_product);
	$rowcount_product=mysqli_num_rows($result_product);
 	while($row_product=mysqli_fetch_assoc($result_product)){
	$product_title= $row_product["title"];
	$product_category= $row_product["category"];
	$product_description= $row_product["discription"];
	$product_tags= $row_product["tag"];
	$sale_price= $row_product["sale_price"];
	$real_price= intval($row_product["real_price"]);	
	
	$per_pro_pri=$sale_price*$quantity_id_qty_cart;
    $all_total_price+=$per_pro_pri;
	
	
	}
	
	$get_users_images="SELECT * FROM `multiple_images` order by product_id='".$product_id_qty_cart."' desc limit 1";
	$result_images=mysqli_query($conn,$get_users_images);
	  ...
	  ?>
			...
			<tr class="cart-item" id="CartItem-1">
                  <td class="cart-item__media">
                      ...
                      <a href="/products/over-ear-usb-headset?variant=31374808023103">
                      <img class="cart-item__image img-fluid mx-auto"
                        src="./admin/<?php echo 'admin_pics'; ?>/<?php echo $image_name; ?>"
                        alt="Over-Ear USB Headset"
                        loading="lazy"
                        width="150"
                        height="150" >
                      </a>
                  ...
                  <td class="cart-item__details"><a href="/products/over-ear-usb-headset?variant=31374808023103" class="cart-item__name h4 break"><?php echo $product_title	; ?></a><div class="product-option">
                        $ <?php echo $sale_price; ?>
                  ...
                  <td class="cart-item__quantity">
				  					<input type="hidden" value="<?php echo $product_id_qty_cart; ?>" name="pro_id[]"/>
                    ...
                    <div class="cart-item__quantity-wrapper">
                      ...
                      <quantity-input class="quantity">
                        <button class="quantity__button no-js-hidden" name="minus" type="button">
                          <span class="visually-hidden">Decrease quantity for Over-Ear USB Headset</span>
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M.5 1C.5.7.7.5 1 .5h8a.5.5 0 110 1H1A.5.5 0 01.5 1z" fill="currentColor">
                        ...
                        <input class="quantity__input"
                          type="number"
                          name="qty[]"
                          value="<?php echo $quantity_id_qty_cart; ?>"
                          min="1"
                          aria-label="Quantity for Over-Ear USB Headset"
                          id="Quantity-1"
                          data-index="1"
                        >
                        <button class="quantity__button no-js-hidden" name="plus" type="button">
                          <span class="visually-hidden">Increase quantity for Over-Ear USB Headset</span>
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M1 4.51a.5.5 0 000 1h3.5l.01 3.5a.5.5 0 001-.01V5.5l3.5-.01a.5.5 0 00-.01-1H5.5L5.49.99a.5.5 0 00-1 .01v3.5l-3.5.01H1z" fill="currentColor">
				...
				<a href="cart.php?delete_product=<?php echo $product_id_qty_cart; ?>" title="Del <?php echo $product_title; ?>">

 &nbsp;&nbsp;<svg xmlns="http://www.w3.org/2000/svg" height="3em" viewBox="0 0 16 16" aria-hidden="true" focusable="false" role="presentation" class="icon icon-remove">
...
</div><div id="shopify-section-template--14270126129215__cart-footer" class="shopify-section cart__footer-wrapper"><link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-cart.css?v=120599242479404763711645685321" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-totals.css?v=93346863290357109701645685330" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-price.css?v=75926142592083736931648449696" rel="stylesheet" type="text/css" media="all" />
<link href="https://cdn.shopify.com/s/files/1/0257/0492/3199/t/5/assets/component-discounts.css?v=13156439235383754671645685322" rel="stylesheet" type="text/css" media="all" />
...
<div class="" id="main-cart-footer" data-id="template--14270126129215__cart-footer">
    <div class="cart__footer"><div class="cart__blocks">
        
<div class="js-contents" >

<input type="submit" value="Update" name="cart_updated" class="update_botton"/>

				
				</form>	
                <div class="totals">
                  <h3 class="totals__subtotal">Subtotal:</h3>
                  <p class="totals__subtotal-value">$ <?php echo $all_total_price; ?></p>
                </div>
